	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f8:	0f be 80 11 1e 80 00 	movsbl 0x801e11(%eax),%eax
  8001ff:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80033c:	ff 24 85 60 1f 80 00 	jmp    *0x801f60(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003e8:	8b 04 85 c0 20 80 00 	mov    0x8020c0(,%eax,4),%eax
  8003ef:	85 c0                	test   %eax,%eax
  8003f1:	75 1a                	jne    80040d <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003f3:	52                   	push   %edx
  8003f4:	68 29 1e 80 00       	push   $0x801e29
  8003f9:	57                   	push   %edi
  ...
  80040d:	50                   	push   %eax
  80040e:	68 f7 21 80 00       	push   $0x8021f7
  800413:	57                   	push   %edi
  ...
  800442:	75 07                	jne    80044b <vprintfmt+0x19a>
				p = "(null)";
  800444:	c7 45 d0 22 1e 80 00 	movl   $0x801e22,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ab2:	68 1f 21 80 00       	push   $0x80211f
  800ab7:	6a 42                	push   $0x42
  800ab9:	68 3c 21 80 00       	push   $0x80213c
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800de5:	40                   	inc    %eax
  800de6:	8b 14 85 c8 21 80 00 	mov    0x8021c8(,%eax,4),%edx
  ...
  800dfc:	51                   	push   %ecx
  800dfd:	50                   	push   %eax
  800dfe:	68 4c 21 80 00       	push   $0x80214c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80102c:	53                   	push   %ebx
  80102d:	50                   	push   %eax
  80102e:	68 8d 21 80 00       	push   $0x80218d
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011ae:	53                   	push   %ebx
  8011af:	50                   	push   %eax
  8011b0:	68 6c 21 80 00       	push   $0x80216c
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  801312:	68 d8 21 80 00       	push   $0x8021d8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013a1:	68 de 21 80 00       	push   $0x8021de
  8013a6:	68 e5 21 80 00       	push   $0x8021e5
  8013ab:	68 80 00 00 00       	push   $0x80
  8013b0:	68 fa 21 80 00       	push   $0x8021fa
  8013b5:	e8 de 05 00 00       	call   801998 <_panic>
	assert(r <= PGSIZE);
  8013ba:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8013bf:	7e 19                	jle    8013da <devfile_read+0x6b>
  8013c1:	68 05 22 80 00       	push   $0x802205
  8013c6:	68 e5 21 80 00       	push   $0x8021e5
  8013cb:	68 81 00 00 00       	push   $0x81
  8013d0:	68 fa 21 80 00       	push   $0x8021fa
...
open(const char *path, int mode)
{
  ...
  801468:	68 11 22 80 00       	push   $0x802211
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014ac:	68 17 22 80 00       	push   $0x802217
  8014b1:	56                   	push   %esi
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801562:	50                   	push   %eax
  801563:	53                   	push   %ebx
  801564:	68 1e 22 80 00       	push   $0x80221e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801818:	68 36 22 80 00       	push   $0x802236
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019b4:	53                   	push   %ebx
  8019b5:	50                   	push   %eax
  8019b6:	68 44 22 80 00       	push   $0x802244
  ...
  8019c7:	e8 2f e7 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  8019cc:	c7 04 24 15 22 80 00 	movl   $0x802215,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8019f3:	53                   	push   %ebx
  8019f4:	57                   	push   %edi
  8019f5:	68 68 22 80 00       	push   $0x802268
  ...
  801a09:	68 78 22 80 00       	push   $0x802278
  ...
  801a1b:	89 c3                	mov    %eax,%ebx
		cprintf("OVER\n");
  801a1d:	c7 04 24 d8 21 80 00 	movl   $0x8021d8,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ab1:	50                   	push   %eax
  801ab2:	68 7f 22 80 00       	push   $0x80227f
  801ab7:	6a 45                	push   $0x45
  801ab9:	68 92 22 80 00       	push   $0x802292
