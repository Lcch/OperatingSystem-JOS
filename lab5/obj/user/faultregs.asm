...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8005a8:	53                   	push   %ebx
  8005a9:	50                   	push   %eax
  8005aa:	68 60 24 80 00       	push   $0x802460
  ...
  8005bb:	e8 53 00 00 00       	call   800613 <vcprintf>
	cprintf("\n");
  8005c0:	c7 04 24 70 23 80 00 	movl   $0x802370,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8006cc:	e8 0f 1a 00 00       	call   8020e0 <__udivdi3>
  ...
  800708:	e8 ef 1a 00 00       	call   8021fc <__umoddi3>
  80070d:	83 c4 14             	add    $0x14,%esp
  800710:	0f be 80 83 24 80 00 	movsbl 0x802483(%eax),%eax
  800717:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800854:	ff 24 85 c0 25 80 00 	jmp    *0x8025c0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800900:	8b 04 85 20 27 80 00 	mov    0x802720(,%eax,4),%eax
  800907:	85 c0                	test   %eax,%eax
  800909:	75 1a                	jne    800925 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  80090b:	52                   	push   %edx
  80090c:	68 9b 24 80 00       	push   $0x80249b
  800911:	57                   	push   %edi
  ...
  800925:	50                   	push   %eax
  800926:	68 ab 28 80 00       	push   $0x8028ab
  80092b:	57                   	push   %edi
  ...
  80095a:	75 07                	jne    800963 <vprintfmt+0x19a>
				p = "(null)";
  80095c:	c7 45 d0 94 24 80 00 	movl   $0x802494,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fca:	68 7f 27 80 00       	push   $0x80277f
  800fcf:	6a 42                	push   $0x42
  800fd1:	68 9c 27 80 00       	push   $0x80279c
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801203:	50                   	push   %eax
  801204:	68 aa 27 80 00       	push   $0x8027aa
  801209:	6a 24                	push   $0x24
  80120b:	68 c5 27 80 00       	push   $0x8027c5
  ...
  80122b:	50                   	push   %eax
  80122c:	68 d4 27 80 00       	push   $0x8027d4
  801231:	6a 2a                	push   $0x2a
  801233:	68 c5 27 80 00       	push   $0x8027c5
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  801391:	40                   	inc    %eax
  801392:	8b 14 85 7c 28 80 00 	mov    0x80287c(,%eax,4),%edx
  ...
  8013a8:	51                   	push   %ecx
  8013a9:	50                   	push   %eax
  8013aa:	68 fc 27 80 00       	push   $0x8027fc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8015d8:	53                   	push   %ebx
  8015d9:	50                   	push   %eax
  8015da:	68 40 28 80 00       	push   $0x802840
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8016af:	53                   	push   %ebx
  8016b0:	50                   	push   %eax
  8016b1:	68 5c 28 80 00       	push   $0x80285c
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80175a:	53                   	push   %ebx
  80175b:	50                   	push   %eax
  80175c:	68 1c 28 80 00       	push   $0x80281c
...
stat(const char *path, struct Stat *stat)
{
  ...
  801813:	e8 8b 01 00 00       	call   8019a3 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  80185f:	e8 dd 07 00 00       	call   802041 <ipc_find_env>
  ...
  80187a:	e8 6d 07 00 00       	call   801fec <ipc_send>
  ...
  801887:	e8 b8 06 00 00       	call   801f44 <ipc_recv>
}
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  8018b9:	78 39                	js     8018f4 <devfile_stat+0x61>
		return r;
	}
	cprintf("OVER\n");
  8018bb:	83 ec 0c             	sub    $0xc,%esp
  8018be:	68 8c 28 80 00       	push   $0x80288c
  8018c3:	e8 9c ed ff ff       	call   800664 <cprintf>
	strcpy(st->st_name, fsipcbuf.statRet.ret_name);
  8018c8:	83 c4 08             	add    $0x8,%esp
  8018cb:	68 00 50 80 00       	push   $0x805000
  8018d0:	53                   	push   %ebx
  8018d1:	e8 44 f3 ff ff       	call   800c1a <strcpy>
...
devfile_flush(struct Fd *fd)
{
  ...
  801914:	e8 2f ff ff ff       	call   801848 <fsipc>
}
  801919:	c9                   	leave  
  80191a:	c3                   	ret    
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80193e:	e8 05 ff ff ff       	call   801848 <fsipc>
  801943:	89 c3                	mov    %eax,%ebx
  801945:	85 c0                	test   %eax,%eax
  801947:	78 51                	js     80199a <devfile_read+0x7f>
		return r;
	assert(r <= n);
  801949:	39 c6                	cmp    %eax,%esi
  80194b:	73 19                	jae    801966 <devfile_read+0x4b>
  80194d:	68 92 28 80 00       	push   $0x802892
  801952:	68 99 28 80 00       	push   $0x802899
  801957:	68 80 00 00 00       	push   $0x80
  80195c:	68 ae 28 80 00       	push   $0x8028ae
  801961:	e8 26 ec ff ff       	call   80058c <_panic>
	assert(r <= PGSIZE);
  801966:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80196b:	7e 19                	jle    801986 <devfile_read+0x6b>
  80196d:	68 b9 28 80 00       	push   $0x8028b9
  801972:	68 99 28 80 00       	push   $0x802899
  801977:	68 81 00 00 00       	push   $0x81
  80197c:	68 ae 28 80 00       	push   $0x8028ae
  801981:	e8 06 ec ff ff       	call   80058c <_panic>
	memmove(buf, &fsipcbuf, r);
  801986:	83 ec 04             	sub    $0x4,%esp
  801989:	50                   	push   %eax
  80198a:	68 00 50 80 00       	push   $0x805000
  80198f:	ff 75 0c             	pushl  0xc(%ebp)
  801992:	e8 44 f4 ff ff       	call   800ddb <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8019ae:	56                   	push   %esi
  8019af:	e8 14 f2 ff ff       	call   800bc8 <strlen>
  8019b4:	83 c4 10             	add    $0x10,%esp
  8019b7:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  8019bc:	7f 72                	jg     801a30 <open+0x8d>
		return -E_BAD_PATH;
  ...
  8019c4:	50                   	push   %eax
  8019c5:	e8 ce f8 ff ff       	call   801298 <fd_alloc>
  8019ca:	89 c3                	mov    %eax,%ebx
  8019cc:	83 c4 10             	add    $0x10,%esp
  8019cf:	85 c0                	test   %eax,%eax
  8019d1:	78 62                	js     801a35 <open+0x92>
		return r;
  ...
  8019dc:	e8 39 f2 ff ff       	call   800c1a <strcpy>
	fsipcbuf.open.req_omode = mode;
  8019e1:	8b 45 0c             	mov    0xc(%ebp),%eax
  8019e4:	a3 00 54 80 00       	mov    %eax,0x805400



	if ((r = fsipc(FSREQ_OPEN, fd)) < 0) {
  8019e9:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8019ec:	b8 01 00 00 00       	mov    $0x1,%eax
  8019f1:	e8 52 fe ff ff       	call   801848 <fsipc>
  8019f6:	89 c3                	mov    %eax,%ebx
  8019f8:	83 c4 10             	add    $0x10,%esp
  8019fb:	85 c0                	test   %eax,%eax
  8019fd:	79 12                	jns    801a11 <open+0x6e>
		fd_close(fd, 0);
  8019ff:	83 ec 08             	sub    $0x8,%esp
  801a02:	6a 00                	push   $0x0
  801a04:	ff 75 f4             	pushl  -0xc(%ebp)
  801a07:	e8 bb f9 ff ff       	call   8013c7 <fd_close>
		return r;
  801a0c:	83 c4 10             	add    $0x10,%esp
  801a0f:	eb 24                	jmp    801a35 <open+0x92>
	}


	cprintf("OPEN\n");
  801a11:	83 ec 0c             	sub    $0xc,%esp
  801a14:	68 c5 28 80 00       	push   $0x8028c5
  801a19:	e8 46 ec ff ff       	call   800664 <cprintf>

	return fd2num(fd);
  801a1e:	83 c4 04             	add    $0x4,%esp
  801a21:	ff 75 f4             	pushl  -0xc(%ebp)
  801a24:	e8 47 f8 ff ff       	call   801270 <fd2num>
  801a29:	89 c3                	mov    %eax,%ebx
  801a2b:	83 c4 10             	add    $0x10,%esp
  801a2e:	eb 05                	jmp    801a35 <open+0x92>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  801a30:	bb f4 ff ff ff       	mov    $0xfffffff4,%ebx
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a4e:	e8 2d f8 ff ff       	call   801280 <fd2data>
  801a53:	89 c3                	mov    %eax,%ebx
	strcpy(stat->st_name, "<pipe>");
  801a55:	83 c4 08             	add    $0x8,%esp
  801a58:	68 cb 28 80 00       	push   $0x8028cb
  801a5d:	56                   	push   %esi
  801a5e:	e8 b7 f1 ff ff       	call   800c1a <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801a63:	8b 43 04             	mov    0x4(%ebx),%eax
  801a66:	2b 03                	sub    (%ebx),%eax
  801a68:	89 86 80 00 00 00    	mov    %eax,0x80(%esi)
	stat->st_isdir = 0;
  801a6e:	c7 86 84 00 00 00 00 	movl   $0x0,0x84(%esi)
  801a75:	00 00 00 
	stat->st_dev = &devpipe;
  801a78:	c7 86 88 00 00 00 20 	movl   $0x803020,0x88(%esi)
  801a7f:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801a9b:	e8 46 f6 ff ff       	call   8010e6 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801aa0:	89 1c 24             	mov    %ebx,(%esp)
  801aa3:	e8 d8 f7 ff ff       	call   801280 <fd2data>
  801aa8:	83 c4 08             	add    $0x8,%esp
  801aab:	50                   	push   %eax
  801aac:	6a 00                	push   $0x0
  801aae:	e8 33 f6 ff ff       	call   8010e6 <sys_page_unmap>
}
  801ab3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801ab6:	c9                   	leave  
  801ab7:	c3                   	ret    

00801ab8 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801ac3:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801ac6:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801acb:	8b 58 58             	mov    0x58(%eax),%ebx
		ret = pageref(fd) == pageref(p);
  801ace:	83 ec 0c             	sub    $0xc,%esp
  801ad1:	57                   	push   %edi
  801ad2:	e8 c5 05 00 00       	call   80209c <pageref>
  801ad7:	89 c6                	mov    %eax,%esi
  801ad9:	83 c4 04             	add    $0x4,%esp
  801adc:	ff 75 e4             	pushl  -0x1c(%ebp)
  801adf:	e8 b8 05 00 00       	call   80209c <pageref>
  801ae4:	83 c4 10             	add    $0x10,%esp
  801ae7:	39 c6                	cmp    %eax,%esi
  801ae9:	0f 94 c0             	sete   %al
  801aec:	0f b6 c0             	movzbl %al,%eax
		nn = thisenv->env_runs;
  801aef:	8b 15 b0 40 80 00    	mov    0x8040b0,%edx
  801af5:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801af8:	39 cb                	cmp    %ecx,%ebx
  801afa:	75 08                	jne    801b04 <_pipeisclosed+0x4c>
			return ret;
		if (n != nn && ret == 1)
  ...
  801b07:	75 bd                	jne    801ac6 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801b09:	8b 42 58             	mov    0x58(%edx),%eax
  801b0c:	6a 01                	push   $0x1
  801b0e:	50                   	push   %eax
  801b0f:	53                   	push   %ebx
  801b10:	68 d2 28 80 00       	push   $0x8028d2
  801b15:	e8 4a eb ff ff       	call   800664 <cprintf>
  801b1a:	83 c4 10             	add    $0x10,%esp
  801b1d:	eb a7                	jmp    801ac6 <_pipeisclosed+0xe>

00801b1f <devpipe_write>:
	return i;
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801b28:	8b 75 08             	mov    0x8(%ebp),%esi
	const uint8_t *buf;
	size_t i;
	struct Pipe *p;
  ...
  801b2b:	56                   	push   %esi
  801b2c:	e8 4f f7 ff ff       	call   801280 <fd2data>
  ...
  801b3a:	75 4a                	jne    801b86 <devpipe_write+0x67>
  801b3c:	bf 00 00 00 00       	mov    $0x0,%edi
  801b41:	eb 56                	jmp    801b99 <devpipe_write+0x7a>
  ...
  801b47:	e8 6c ff ff ff       	call   801ab8 <_pipeisclosed>
  801b4c:	85 c0                	test   %eax,%eax
  801b4e:	75 4d                	jne    801b9d <devpipe_write+0x7e>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  801b50:	e8 20 f5 ff ff       	call   801075 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801b58:	8b 13                	mov    (%ebx),%edx
  801b5a:	83 c2 20             	add    $0x20,%edx
  801b5d:	39 d0                	cmp    %edx,%eax
  801b5f:	73 e2                	jae    801b43 <devpipe_write+0x24>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801b63:	81 e2 1f 00 00 80    	and    $0x8000001f,%edx
  801b69:	79 05                	jns    801b70 <devpipe_write+0x51>
  801b6b:	4a                   	dec    %edx
  801b6c:	83 ca e0             	or     $0xffffffe0,%edx
  801b6f:	42                   	inc    %edx
  801b70:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801b73:	8a 0c 39             	mov    (%ecx,%edi,1),%cl
  ...
  801b7b:	89 43 04             	mov    %eax,0x4(%ebx)
	...
	for (i = 0; i < n; i++) {
  801b7e:	47                   	inc    %edi
  801b7f:	39 7d 10             	cmp    %edi,0x10(%ebp)
  801b82:	77 07                	ja     801b8b <devpipe_write+0x6c>
  801b84:	eb 13                	jmp    801b99 <devpipe_write+0x7a>
  801b86:	bf 00 00 00 00       	mov    $0x0,%edi
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801b8b:	8b 43 04             	mov    0x4(%ebx),%eax
  801b8e:	8b 13                	mov    (%ebx),%edx
  801b90:	83 c2 20             	add    $0x20,%edx
  801b93:	39 d0                	cmp    %edx,%eax
  801b95:	73 ac                	jae    801b43 <devpipe_write+0x24>
  801b97:	eb c8                	jmp    801b61 <devpipe_write+0x42>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801b9b:	eb 05                	jmp    801ba2 <devpipe_write+0x83>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801bb3:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801bb6:	57                   	push   %edi
  801bb7:	e8 c4 f6 ff ff       	call   801280 <fd2data>
  ...
  801bc5:	75 44                	jne    801c0b <devpipe_read+0x61>
  801bc7:	be 00 00 00 00       	mov    $0x0,%esi
  801bcc:	eb 4f                	jmp    801c1d <devpipe_read+0x73>
  ...
  801bd0:	eb 54                	jmp    801c26 <devpipe_read+0x7c>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  801bd2:	89 da                	mov    %ebx,%edx
  801bd4:	89 f8                	mov    %edi,%eax
  801bd6:	e8 dd fe ff ff       	call   801ab8 <_pipeisclosed>
  801bdb:	85 c0                	test   %eax,%eax
  801bdd:	75 42                	jne    801c21 <devpipe_read+0x77>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801bdf:	e8 91 f4 ff ff       	call   801075 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  801be4:	8b 03                	mov    (%ebx),%eax
  801be6:	3b 43 04             	cmp    0x4(%ebx),%eax
  801be9:	74 e7                	je     801bd2 <devpipe_read+0x28>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801beb:	25 1f 00 00 80       	and    $0x8000001f,%eax
  801bf0:	79 05                	jns    801bf7 <devpipe_read+0x4d>
  801bf2:	48                   	dec    %eax
  801bf3:	83 c8 e0             	or     $0xffffffe0,%eax
  801bf6:	40                   	inc    %eax
  801bf7:	8a 44 03 08          	mov    0x8(%ebx,%eax,1),%al
  801bfb:	8b 55 0c             	mov    0xc(%ebp),%edx
  801bfe:	88 04 32             	mov    %al,(%edx,%esi,1)
		p->p_rpos++;
  801c01:	ff 03                	incl   (%ebx)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
  801c03:	46                   	inc    %esi
  801c04:	39 75 10             	cmp    %esi,0x10(%ebp)
  801c07:	77 07                	ja     801c10 <devpipe_read+0x66>
  801c09:	eb 12                	jmp    801c1d <devpipe_read+0x73>
  801c0b:	be 00 00 00 00       	mov    $0x0,%esi
		while (p->p_rpos == p->p_wpos) {
  801c10:	8b 03                	mov    (%ebx),%eax
  801c12:	3b 43 04             	cmp    0x4(%ebx),%eax
  801c15:	75 d4                	jne    801beb <devpipe_read+0x41>
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801c17:	85 f6                	test   %esi,%esi
  801c19:	75 b3                	jne    801bce <devpipe_read+0x24>
  801c1b:	eb b5                	jmp    801bd2 <devpipe_read+0x28>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801c1f:	eb 05                	jmp    801c26 <devpipe_read+0x7c>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  801cad:	e8 ce f5 ff ff       	call   801280 <fd2data>
  ...
  801d27:	e8 44 f5 ff ff       	call   801270 <fd2num>
  801d2c:	89 07                	mov    %eax,(%edi)
	pfd[1] = fd2num(fd1);
  801d2e:	83 c4 04             	add    $0x4,%esp
  801d31:	ff 75 e0             	pushl  -0x20(%ebp)
  801d34:	e8 37 f5 ff ff       	call   801270 <fd2num>
  801d39:	89 47 04             	mov    %eax,0x4(%edi)
	return 0;
  801d3c:	83 c4 10             	add    $0x10,%esp
  801d3f:	bb 00 00 00 00       	mov    $0x0,%ebx
  801d44:	eb 2e                	jmp    801d74 <pipe+0x146>
  ...
  801d5c:	e8 85 f3 ff ff       	call   8010e6 <sys_page_unmap>
  801d61:	83 c4 10             	add    $0x10,%esp
    err1:
	sys_page_unmap(0, fd0);
  801d64:	83 ec 08             	sub    $0x8,%esp
  801d67:	ff 75 e4             	pushl  -0x1c(%ebp)
  801d6a:	6a 00                	push   $0x0
  801d6c:	e8 75 f3 ff ff       	call   8010e6 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801d8b:	e8 7b f5 ff ff       	call   80130b <fd_lookup>
  ...
  801d9d:	e8 de f4 ff ff       	call   801280 <fd2data>
	return _pipeisclosed(fd, p);
  801da2:	89 c2                	mov    %eax,%edx
  801da4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801da7:	e8 0c fd ff ff       	call   801ab8 <_pipeisclosed>
  801dac:	83 c4 10             	add    $0x10,%esp
}
  801daf:	c9                   	leave  
  801db0:	c3                   	ret    
  801db1:	00 00                	add    %al,(%eax)
	...
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dc4:	68 ea 28 80 00       	push   $0x8028ea
  801dc9:	ff 75 0c             	pushl  0xc(%ebp)
  801dcc:	e8 49 ee ff ff       	call   800c1a <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801de8:	74 45                	je     801e2f <devcons_write+0x57>
  ...
  801df4:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	char buf[128];
  ...
  801dfd:	29 c3                	sub    %eax,%ebx
		if (m > sizeof(buf) - 1)
  801dff:	83 fb 7f             	cmp    $0x7f,%ebx
  801e02:	76 05                	jbe    801e09 <devcons_write+0x31>
			m = sizeof(buf) - 1;
  801e04:	bb 7f 00 00 00       	mov    $0x7f,%ebx
		memmove(buf, (char*)vbuf + tot, m);
  ...
  801e10:	50                   	push   %eax
  801e11:	57                   	push   %edi
  801e12:	e8 c4 ef ff ff       	call   800ddb <memmove>
		sys_cputs(buf, m);
  801e17:	83 c4 08             	add    $0x8,%esp
  801e1a:	53                   	push   %ebx
  801e1b:	57                   	push   %edi
  801e1c:	e8 c4 f1 ff ff       	call   800fe5 <sys_cputs>
	int tot, m;
	char buf[128];
  ...
  801e2b:	72 cd                	jb     801dfa <devcons_write+0x22>
  801e2d:	eb 05                	jmp    801e34 <devcons_write+0x5c>
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801e48:	75 07                	jne    801e51 <devcons_read+0x13>
  801e4a:	eb 25                	jmp    801e71 <devcons_read+0x33>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801e4c:	e8 24 f2 ff ff       	call   801075 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801e51:	e8 b5 f1 ff ff       	call   80100b <sys_cgetc>
  801e56:	85 c0                	test   %eax,%eax
  801e58:	74 f2                	je     801e4c <devcons_read+0xe>
  801e5a:	89 c2                	mov    %eax,%edx
		sys_yield();
	if (c < 0)
  801e5c:	85 c0                	test   %eax,%eax
  801e5e:	78 1d                	js     801e7d <devcons_read+0x3f>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801e60:	83 f8 04             	cmp    $0x4,%eax
  801e63:	74 13                	je     801e78 <devcons_read+0x3a>
		return 0;
	*(char*)vbuf = c;
  ...
  801e6f:	eb 0c                	jmp    801e7d <devcons_read+0x3f>
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
	int c;
  ...
  801e76:	eb 05                	jmp    801e7d <devcons_read+0x3f>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801e90:	50                   	push   %eax
  801e91:	e8 4f f1 ff ff       	call   800fe5 <sys_cputs>
...
getchar(void)
{
  ...
  801ea9:	e8 de f6 ff ff       	call   80158c <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  801ed3:	e8 33 f4 ff ff       	call   80130b <fd_lookup>
...
opencons(void)
{
  ...
  801efb:	50                   	push   %eax
  801efc:	e8 97 f3 ff ff       	call   801298 <fd_alloc>
  801f01:	83 c4 10             	add    $0x10,%esp
  801f04:	85 c0                	test   %eax,%eax
  801f06:	78 3a                	js     801f42 <opencons+0x50>
		return r;
  ...
  801f15:	e8 82 f1 ff ff       	call   80109c <sys_page_alloc>
  801f1a:	83 c4 10             	add    $0x10,%esp
  801f1d:	85 c0                	test   %eax,%eax
  801f1f:	78 21                	js     801f42 <opencons+0x50>
		return r;
  ...
  801f39:	50                   	push   %eax
  801f3a:	e8 31 f3 ff ff       	call   801270 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f57:	53                   	push   %ebx
  801f58:	57                   	push   %edi
  801f59:	68 f6 28 80 00       	push   $0x8028f6
  801f5e:	e8 01 e7 ff ff       	call   800664 <cprintf>
	int r;
	if (pg != NULL) {
  801f63:	83 c4 10             	add    $0x10,%esp
  801f66:	85 db                	test   %ebx,%ebx
  801f68:	74 28                	je     801f92 <ipc_recv+0x4e>
		cprintf("BEGIN\n");
  801f6a:	83 ec 0c             	sub    $0xc,%esp
  801f6d:	68 06 29 80 00       	push   $0x802906
  801f72:	e8 ed e6 ff ff       	call   800664 <cprintf>
		r = sys_ipc_recv(pg);
  801f77:	89 1c 24             	mov    %ebx,(%esp)
  801f7a:	e8 18 f2 ff ff       	call   801197 <sys_ipc_recv>
  801f7f:	89 c3                	mov    %eax,%ebx
		cprintf("OVER\n");
  801f81:	c7 04 24 8c 28 80 00 	movl   $0x80288c,(%esp)
  801f88:	e8 d7 e6 ff ff       	call   800664 <cprintf>
  801f8d:	83 c4 10             	add    $0x10,%esp
  801f90:	eb 12                	jmp    801fa4 <ipc_recv+0x60>
	} else {
		r = sys_ipc_recv((void *)UTOP);
  801f92:	83 ec 0c             	sub    $0xc,%esp
  801f95:	68 00 00 c0 ee       	push   $0xeec00000
  801f9a:	e8 f8 f1 ff ff       	call   801197 <sys_ipc_recv>
  ...
  801fa6:	75 26                	jne    801fce <ipc_recv+0x8a>
		if (from_env_store != NULL) *from_env_store = thisenv->env_ipc_from;
  801fa8:	85 ff                	test   %edi,%edi
  801faa:	74 0a                	je     801fb6 <ipc_recv+0x72>
  801fac:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801fb1:	8b 40 74             	mov    0x74(%eax),%eax
  801fb4:	89 07                	mov    %eax,(%edi)
		if (perm_store != NULL) *perm_store = thisenv->env_ipc_perm;
  801fb6:	85 f6                	test   %esi,%esi
  801fb8:	74 0a                	je     801fc4 <ipc_recv+0x80>
  801fba:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801fbf:	8b 40 78             	mov    0x78(%eax),%eax
  801fc2:	89 06                	mov    %eax,(%esi)
		return thisenv->env_ipc_value;
  801fc4:	a1 b0 40 80 00       	mov    0x8040b0,%eax
  801fc9:	8b 58 70             	mov    0x70(%eax),%ebx
  801fcc:	eb 14                	jmp    801fe2 <ipc_recv+0x9e>
	} else {
		// fails;
		if (from_env_store != NULL) *from_env_store = 0;
  801fce:	85 ff                	test   %edi,%edi
  801fd0:	74 06                	je     801fd8 <ipc_recv+0x94>
  801fd2:	c7 07 00 00 00 00    	movl   $0x0,(%edi)
		if (perm_store != NULL) *perm_store = 0;
  801fd8:	85 f6                	test   %esi,%esi
  801fda:	74 06                	je     801fe2 <ipc_recv+0x9e>
  801fdc:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		return r;
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ff5:	8b 7d 0c             	mov    0xc(%ebp),%edi
  801ff8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801ffb:	8b 75 14             	mov    0x14(%ebp),%esi
	// LAB 4: Your code here.
	// int sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
	int r;
	if (pg == NULL) pg = (void *)UTOP;
  801ffe:	85 db                	test   %ebx,%ebx
  802000:	75 25                	jne    802027 <ipc_send+0x3b>
  802002:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  802007:	eb 1e                	jmp    802027 <ipc_send+0x3b>
	
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) != 0) {
		if (r == -E_IPC_NOT_RECV) {
  802009:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80200c:	75 07                	jne    802015 <ipc_send+0x29>
			// cprintf("Try Again and Again....\n");
			sys_yield();
  80200e:	e8 62 f0 ff ff       	call   801075 <sys_yield>
  802013:	eb 12                	jmp    802027 <ipc_send+0x3b>
		} else {
			panic("ipc_send error %e\n", r);
  802015:	50                   	push   %eax
  802016:	68 0d 29 80 00       	push   $0x80290d
  80201b:	6a 45                	push   $0x45
  80201d:	68 20 29 80 00       	push   $0x802920
  802022:	e8 65 e5 ff ff       	call   80058c <_panic>
	// LAB 4: Your code here.
	// int sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
	int r;
	if (pg == NULL) pg = (void *)UTOP;
  ...
  80202d:	e8 40 f1 ff ff       	call   801172 <sys_ipc_try_send>
  802032:	83 c4 10             	add    $0x10,%esp
  802035:	85 c0                	test   %eax,%eax
  802037:	75 d0                	jne    802009 <ipc_send+0x1d>
		} else {
			panic("ipc_send error %e\n", r);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  802048:	39 1d 50 00 c0 ee    	cmp    %ebx,0xeec00050
  80204e:	74 22                	je     802072 <ipc_find_env+0x31>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802050:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  802055:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  80205c:	89 c2                	mov    %eax,%edx
  80205e:	c1 e2 07             	shl    $0x7,%edx
  802061:	29 ca                	sub    %ecx,%edx
  802063:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  802069:	8b 52 50             	mov    0x50(%edx),%edx
  80206c:	39 da                	cmp    %ebx,%edx
  80206e:	75 1d                	jne    80208d <ipc_find_env+0x4c>
  802070:	eb 05                	jmp    802077 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80207e:	c1 e0 07             	shl    $0x7,%eax
  802081:	29 d0                	sub    %edx,%eax
  802083:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  802088:	8b 40 40             	mov    0x40(%eax),%eax
  80208b:	eb 0c                	jmp    802099 <ipc_find_env+0x58>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802093:	75 c0                	jne    802055 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  802095:	66 b8 00 00          	mov    $0x0,%ax
}
  802099:	5b                   	pop    %ebx
  80209a:	c9                   	leave  
  80209b:	c3                   	ret    
...
pageref(void *v)
{
  ...
  8020a4:	c1 ea 16             	shr    $0x16,%edx
  8020a7:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  8020ae:	f6 c2 01             	test   $0x1,%dl
  8020b1:	74 1e                	je     8020d1 <pageref+0x35>
		return 0;
	pte = uvpt[PGNUM(v)];
  8020b3:	c1 e8 0c             	shr    $0xc,%eax
  8020b6:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  8020bd:	a8 01                	test   $0x1,%al
  8020bf:	74 17                	je     8020d8 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  8020c1:	c1 e8 0c             	shr    $0xc,%eax
  8020c4:	66 8b 04 c5 04 00 00 	mov    -0x10fffffc(,%eax,8),%ax
  8020cb:	ef 
  8020cc:	0f b7 c0             	movzwl %ax,%eax
  8020cf:	eb 0c                	jmp    8020dd <pageref+0x41>
pageref(void *v)
{
	pte_t pte;
  ...
  8020d6:	eb 05                	jmp    8020dd <pageref+0x41>
	pte = uvpt[PGNUM(v)];
	if (!(pte & PTE_P))
		return 0;
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  8020ee:	89 7d f0             	mov    %edi,-0x10(%ebp)
  ...
  8020fc:	75 2e                	jne    80212c <__udivdi3+0x4c>
    {
      if (d0 > n1)
  8020fe:	39 f1                	cmp    %esi,%ecx
  802100:	77 5a                	ja     80215c <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  802104:	75 0b                	jne    802111 <__udivdi3+0x31>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  80212e:	77 1c                	ja     80214c <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  802130:	0f bd f8             	bsr    %eax,%edi
	  if (bm == 0)
  802133:	83 f7 1f             	xor    $0x1f,%edi
  802136:	75 3c                	jne    802174 <__udivdi3+0x94>
  ...
  80213a:	0f 82 90 00 00 00    	jb     8021d0 <__udivdi3+0xf0>
  802140:	8b 55 f0             	mov    -0x10(%ebp),%edx
  802143:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  802146:	0f 86 84 00 00 00    	jbe    8021d0 <__udivdi3+0xf0>
  80214c:	31 f6                	xor    %esi,%esi
  80214e:	31 ff                	xor    %edi,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  802178:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  80217b:	b8 20 00 00 00       	mov    $0x20,%eax
  ...
  802189:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  80218c:	09 ca                	or     %ecx,%edx
  80218e:	89 55 ec             	mov    %edx,-0x14(%ebp)
	      d0 = d0 << bm;
  802191:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802194:	89 f9                	mov    %edi,%ecx
  802196:	d3 e2                	shl    %cl,%edx
  802198:	89 55 f4             	mov    %edx,-0xc(%ebp)
	      n2 = n1 >> b;
  80219b:	89 f2                	mov    %esi,%edx
  80219d:	88 c1                	mov    %al,%cl
  80219f:	d3 ea                	shr    %cl,%edx
  8021a1:	89 55 e8             	mov    %edx,-0x18(%ebp)
	      n1 = (n1 << bm) | (n0 >> b);
  8021a4:	89 f2                	mov    %esi,%edx
  8021a6:	89 f9                	mov    %edi,%ecx
  8021a8:	d3 e2                	shl    %cl,%edx
  8021aa:	8b 75 f0             	mov    -0x10(%ebp),%esi
  8021ad:	88 c1                	mov    %al,%cl
  8021af:	d3 ee                	shr    %cl,%esi
  8021b1:	09 d6                	or     %edx,%esi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  8021b3:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  8021b6:	89 f0                	mov    %esi,%eax
  8021b8:	89 ca                	mov    %ecx,%edx
  8021ba:	f7 75 ec             	divl   -0x14(%ebp)
  8021bd:	89 d1                	mov    %edx,%ecx
  8021bf:	89 c6                	mov    %eax,%esi
	      umul_ppmm (m1, m0, q0, d0);
  8021c1:	f7 65 f4             	mull   -0xc(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8021c4:	39 d1                	cmp    %edx,%ecx
  8021c6:	72 28                	jb     8021f0 <__udivdi3+0x110>
  8021c8:	74 1a                	je     8021e4 <__udivdi3+0x104>
  8021ca:	89 f7                	mov    %esi,%edi
  8021cc:	31 f6                	xor    %esi,%esi
  8021ce:	eb 80                	jmp    802150 <__udivdi3+0x70>
	      /* The condition on the next line takes advantage of that
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
		{
  ...
  8021d0:	31 f6                	xor    %esi,%esi
  8021d2:	bf 01 00 00 00       	mov    $0x1,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  8021ed:	73 db                	jae    8021ca <__udivdi3+0xea>
  8021ef:	90                   	nop
		{
		  q0--;
  8021f0:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  8021f3:	31 f6                	xor    %esi,%esi
  8021f5:	e9 56 ff ff ff       	jmp    802150 <__udivdi3+0x70>
	...
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  80220d:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  802210:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  802213:	8b 7d 14             	mov    0x14(%ebp),%edi
  UWtype q0, q1;
  UWtype b, bm;
  ...
  80221d:	75 15                	jne    802234 <__umoddi3+0x38>
    {
      if (d0 > n1)
  80221f:	39 f1                	cmp    %esi,%ecx
  802221:	0f 86 99 00 00 00    	jbe    8022c0 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */
  ...
  802236:	0f 87 a4 00 00 00    	ja     8022e0 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  80223c:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  80223f:	83 f0 1f             	xor    $0x1f,%eax
  802242:	89 45 ec             	mov    %eax,-0x14(%ebp)
  802245:	0f 84 a1 00 00 00    	je     8022ec <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  80224d:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  80228d:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  80228f:	f7 65 f4             	mull   -0xc(%ebp)
  802292:	89 55 e8             	mov    %edx,-0x18(%ebp)
  802295:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  802297:	39 d6                	cmp    %edx,%esi
  802299:	72 71                	jb     80230c <__umoddi3+0x110>
  80229b:	74 7f                	je     80231c <__umoddi3+0x120>
	      q1 = 0;
  ...
  8022a0:	29 c8                	sub    %ecx,%eax
  8022a2:	19 d6                	sbb    %edx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  8022a4:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  8022b3:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  8022bf:	90                   	nop
      ...
      else
	{
	  ...
	  if (d0 == 0)
  8022c0:	85 c9                	test   %ecx,%ecx
  8022c2:	75 0b                	jne    8022cf <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  8022da:	e9 4a ff ff ff       	jmp    802229 <__umoddi3+0x2d>
  8022df:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  8022ee:	72 05                	jb     8022f5 <__umoddi3+0xf9>
  8022f0:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  8022f3:	77 0c                	ja     802301 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  8022f5:	89 f2                	mov    %esi,%edx
  8022f7:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8022fa:	29 c8                	sub    %ecx,%eax
  8022fc:	19 fa                	sbb    %edi,%edx
  ...
  802311:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  802314:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  802317:	eb 84                	jmp    80229d <__umoddi3+0xa1>
  802319:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  80231c:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  80231f:	72 eb                	jb     80230c <__umoddi3+0x110>
  802321:	89 f2                	mov    %esi,%edx
  802323:	e9 75 ff ff ff       	jmp    80229d <__umoddi3+0xa1>
