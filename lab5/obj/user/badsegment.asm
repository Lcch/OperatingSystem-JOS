...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000de:	68 aa 1d 80 00       	push   $0x801daa
  8000e3:	6a 42                	push   $0x42
  8000e5:	68 c7 1d 80 00       	push   $0x801dc7
  8000ea:	e8 dd 0e 00 00       	call   800fcc <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8004e6:	e8 0f fd ff ff       	call   8001fa <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8005d0:	e8 ff fb ff ff       	call   8001d4 <sys_page_map>
  ...
  8005fd:	e8 d2 fb ff ff       	call   8001d4 <sys_page_map>
...
err:
  ...
  800611:	e8 e4 fb ff ff       	call   8001fa <sys_page_unmap>
	sys_page_unmap(0, nva);
  800616:	83 c4 08             	add    $0x8,%esp
  800619:	ff 75 d4             	pushl  -0x2c(%ebp)
  80061c:	6a 00                	push   $0x0
  80061e:	e8 d7 fb ff ff       	call   8001fa <sys_page_unmap>
	return r;
...
devpipe_close(struct Fd *fd)
{
  ...
  800b23:	e8 d2 f6 ff ff       	call   8001fa <sys_page_unmap>
  ...
  800b36:	e8 bf f6 ff ff       	call   8001fa <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800bd6:	75 4d                	jne    800c25 <devpipe_write+0x7e>
			...
			sys_yield();
  800bd8:	e8 ac f5 ff ff       	call   800189 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800c65:	75 42                	jne    800ca9 <devpipe_read+0x77>
			...
			sys_yield();
  800c67:	e8 1d f5 ff ff       	call   800189 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800ce5:	e8 c6 f4 ff ff       	call   8001b0 <sys_page_alloc>
  ...
  800d1d:	e8 8e f4 ff ff       	call   8001b0 <sys_page_alloc>
  ...
  800d47:	e8 64 f4 ff ff       	call   8001b0 <sys_page_alloc>
  ...
  800d71:	e8 5e f4 ff ff       	call   8001d4 <sys_page_map>
  ...
  800dd4:	e8 21 f4 ff ff       	call   8001fa <sys_page_unmap>
  ...
  800de4:	e8 11 f4 ff ff       	call   8001fa <sys_page_unmap>
  ...
  800df4:	e8 01 f4 ff ff       	call   8001fa <sys_page_unmap>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800ea2:	53                   	push   %ebx
  800ea3:	57                   	push   %edi
  800ea4:	e8 50 f2 ff ff       	call   8000f9 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800ed2:	eb 25                	jmp    800ef9 <devcons_read+0x33>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  800ed4:	e8 b0 f2 ff ff       	call   800189 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  800ed9:	e8 41 f2 ff ff       	call   80011f <sys_cgetc>
...
cputchar(int ch)
{
  ...
  800f18:	50                   	push   %eax
  800f19:	e8 db f1 ff ff       	call   8000f9 <sys_cputs>
...
opencons(void)
{
  ...
  800f9d:	e8 0e f2 ff ff       	call   8001b0 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fda:	e8 86 f1 ff ff       	call   800165 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  80103c:	50                   	push   %eax
  80103d:	e8 b7 f0 ff ff       	call   8000f9 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801096:	50                   	push   %eax
  801097:	e8 5d f0 ff ff       	call   8000f9 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8019ed:	50                   	push   %eax
  8019ee:	e8 b8 e8 ff ff       	call   8002ab <sys_ipc_recv>
  ...
  801a00:	e8 a6 e8 ff ff       	call   8002ab <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a6d:	75 07                	jne    801a76 <ipc_send+0x29>
			...
			sys_yield();
  801a6f:	e8 15 e7 ff ff       	call   800189 <sys_yield>
  ...
  801a8e:	e8 f3 e7 ff ff       	call   800286 <sys_ipc_try_send>
