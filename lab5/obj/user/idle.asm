...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 30 80 00 a0 	movl   $0x801da0,0x803000
  800041:	1d 80 00 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000ea:	68 af 1d 80 00       	push   $0x801daf
  8000ef:	6a 42                	push   $0x42
  8000f1:	68 cc 1d 80 00       	push   $0x801dcc
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800445:	40                   	inc    %eax
  800446:	8b 14 85 58 1e 80 00 	mov    0x801e58(,%eax,4),%edx
  ...
  80045c:	51                   	push   %ecx
  80045d:	50                   	push   %eax
  80045e:	68 dc 1d 80 00       	push   $0x801ddc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80068c:	53                   	push   %ebx
  80068d:	50                   	push   %eax
  80068e:	68 1d 1e 80 00       	push   $0x801e1d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800763:	53                   	push   %ebx
  800764:	50                   	push   %eax
  800765:	68 39 1e 80 00       	push   $0x801e39
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080e:	53                   	push   %ebx
  80080f:	50                   	push   %eax
  800810:	68 fc 1d 80 00       	push   $0x801dfc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8009f4:	68 68 1e 80 00       	push   $0x801e68
  8009f9:	68 6f 1e 80 00       	push   $0x801e6f
  8009fe:	6a 7d                	push   $0x7d
  800a00:	68 84 1e 80 00       	push   $0x801e84
  800a05:	e8 ce 05 00 00       	call   800fd8 <_panic>
	assert(r <= PGSIZE);
  800a0a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a0f:	7e 16                	jle    800a27 <devfile_read+0x65>
  800a11:	68 8f 1e 80 00       	push   $0x801e8f
  800a16:	68 6f 1e 80 00       	push   $0x801e6f
  800a1b:	6a 7e                	push   $0x7e
  800a1d:	68 84 1e 80 00       	push   $0x801e84
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800aec:	68 9b 1e 80 00       	push   $0x801e9b
  800af1:	56                   	push   %esi
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800ba2:	50                   	push   %eax
  800ba3:	53                   	push   %ebx
  800ba4:	68 a2 1e 80 00       	push   $0x801ea2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e58:	68 ba 1e 80 00       	push   $0x801eba
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ff4:	53                   	push   %ebx
  800ff5:	50                   	push   %eax
  800ff6:	68 c8 1e 80 00       	push   $0x801ec8
  ...
  801007:	e8 53 00 00 00       	call   80105f <vcprintf>
	cprintf("\n");
  80100c:	c7 04 24 b3 1e 80 00 	movl   $0x801eb3,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80115c:	0f be 80 eb 1e 80 00 	movsbl 0x801eeb(%eax),%eax
  801163:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801357:	52                   	push   %edx
  801358:	68 03 1f 80 00       	push   $0x801f03
  80135d:	57                   	push   %edi
  ...
  801371:	50                   	push   %eax
  801372:	68 81 1e 80 00       	push   $0x801e81
  801377:	57                   	push   %edi
  ...
  8013a6:	75 07                	jne    8013af <vprintfmt+0x19a>
				p = "(null)";
  8013a8:	c7 45 d0 fc 1e 80 00 	movl   $0x801efc,-0x30(%ebp)
			if (width > 0 && padc != '-')
