...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000ea:	68 8a 1d 80 00       	push   $0x801d8a
  8000ef:	6a 42                	push   $0x42
  8000f1:	68 a7 1d 80 00       	push   $0x801da7
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  80041d:	40                   	inc    %eax
  80041e:	8b 14 85 34 1e 80 00 	mov    0x801e34(,%eax,4),%edx
  ...
  800434:	51                   	push   %ecx
  800435:	50                   	push   %eax
  800436:	68 b8 1d 80 00       	push   $0x801db8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800664:	53                   	push   %ebx
  800665:	50                   	push   %eax
  800666:	68 f9 1d 80 00       	push   $0x801df9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80073b:	53                   	push   %ebx
  80073c:	50                   	push   %eax
  80073d:	68 15 1e 80 00       	push   $0x801e15
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8007e6:	53                   	push   %ebx
  8007e7:	50                   	push   %eax
  8007e8:	68 d8 1d 80 00       	push   $0x801dd8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8009cc:	68 44 1e 80 00       	push   $0x801e44
  8009d1:	68 4b 1e 80 00       	push   $0x801e4b
  8009d6:	6a 7d                	push   $0x7d
  8009d8:	68 60 1e 80 00       	push   $0x801e60
  ...
  8009ee:	68 4b 1e 80 00       	push   $0x801e4b
  8009f3:	6a 7e                	push   $0x7e
  8009f5:	68 60 1e 80 00       	push   $0x801e60
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ac4:	68 77 1e 80 00       	push   $0x801e77
  800ac9:	56                   	push   %esi
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800b7a:	50                   	push   %eax
  800b7b:	53                   	push   %ebx
  800b7c:	68 7e 1e 80 00       	push   $0x801e7e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e30:	68 96 1e 80 00       	push   $0x801e96
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fcc:	53                   	push   %ebx
  800fcd:	50                   	push   %eax
  800fce:	68 a4 1e 80 00       	push   $0x801ea4
  ...
  800fdf:	e8 53 00 00 00       	call   801037 <vcprintf>
	cprintf("\n");
  800fe4:	c7 04 24 8f 1e 80 00 	movl   $0x801e8f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801134:	0f be 80 c7 1e 80 00 	movsbl 0x801ec7(%eax),%eax
  80113b:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80132f:	52                   	push   %edx
  801330:	68 df 1e 80 00       	push   $0x801edf
  801335:	57                   	push   %edi
  ...
  801349:	50                   	push   %eax
  80134a:	68 5d 1e 80 00       	push   $0x801e5d
  80134f:	57                   	push   %edi
  ...
  80137e:	75 07                	jne    801387 <vprintfmt+0x19a>
				p = "(null)";
  801380:	c7 45 d0 d8 1e 80 00 	movl   $0x801ed8,-0x30(%ebp)
			if (width > 0 && padc != '-')
