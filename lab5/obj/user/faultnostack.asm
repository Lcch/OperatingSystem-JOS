...
umain(int argc, char **argv)
{
  ...
  80003a:	68 30 03 80 00       	push   $0x800330
...
exit(void)
{
  ...
  8000ab:	83 ec 08             	sub    $0x8,%esp
	close_all();
  8000ae:	e8 af 04 00 00       	call   800562 <close_all>
	sys_env_destroy(0);
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000f6:	68 4a 1e 80 00       	push   $0x801e4a
  8000fb:	6a 42                	push   $0x42
  8000fd:	68 67 1e 80 00       	push   $0x801e67
  800102:	e8 05 0f 00 00       	call   80100c <_panic>
...
sys_exec(uint32_t eip, uint32_t esp, void * ph, uint32_t elf_phnum)
{
  ...
  800310:	ff 75 14             	pushl  0x14(%ebp)
  ...
  800321:	b8 0f 00 00 00       	mov    $0xf,%eax
  800326:	e8 99 fd ff ff       	call   8000c4 <syscall>
  80032b:	c9                   	leave  
  80032c:	c3                   	ret    
  80032d:	00 00                	add    %al,(%eax)
	...

00800330 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800331:	a1 00 60 80 00       	mov    0x806000,%eax
	call *%eax
  ...
  800338:	83 c4 04             	add    $0x4,%esp
	...
	// fix old esp
	movl 0x30(%esp), %eax
  80033b:	8b 44 24 30          	mov    0x30(%esp),%eax
	subl $0x4, %eax
  80033f:	83 e8 04             	sub    $0x4,%eax
	movl %eax, 0x30(%esp)
  800342:	89 44 24 30          	mov    %eax,0x30(%esp)

	// set trap-time %eip
	movl 0x28(%esp), %ebx
  800346:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl %ebx, (%eax)
  80034a:	89 18                	mov    %ebx,(%eax)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800479:	40                   	inc    %eax
  80047a:	8b 14 85 f4 1e 80 00 	mov    0x801ef4(,%eax,4),%edx
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800526:	e8 e7 fc ff ff       	call   800212 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800610:	e8 d7 fb ff ff       	call   8001ec <sys_page_map>
  ...
  80063d:	e8 aa fb ff ff       	call   8001ec <sys_page_map>
...
err:
  ...
  800651:	e8 bc fb ff ff       	call   800212 <sys_page_unmap>
	sys_page_unmap(0, nva);
  800656:	83 c4 08             	add    $0x8,%esp
  800659:	ff 75 d4             	pushl  -0x2c(%ebp)
  80065c:	6a 00                	push   $0x0
  80065e:	e8 af fb ff ff       	call   800212 <sys_page_unmap>
	return r;
...
fsipc(unsigned type, void *dstva)
{
  ...
  800947:	e8 02 12 00 00       	call   801b4e <ipc_find_env>
  ...
  800962:	e8 92 11 00 00       	call   801af9 <ipc_send>
  ...
  80096f:	e8 10 11 00 00       	call   801a84 <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a28:	68 04 1f 80 00       	push   $0x801f04
  800a2d:	68 0b 1f 80 00       	push   $0x801f0b
  800a32:	6a 7d                	push   $0x7d
  800a34:	68 20 1f 80 00       	push   $0x801f20
  800a39:	e8 ce 05 00 00       	call   80100c <_panic>
	assert(r <= PGSIZE);
  800a3e:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a43:	7e 16                	jle    800a5b <devfile_read+0x65>
  800a45:	68 2b 1f 80 00       	push   $0x801f2b
  800a4a:	68 0b 1f 80 00       	push   $0x801f0b
  800a4f:	6a 7e                	push   $0x7e
  800a51:	68 20 1f 80 00       	push   $0x801f20
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b20:	68 37 1f 80 00       	push   $0x801f37
  800b25:	56                   	push   %esi
...
devpipe_close(struct Fd *fd)
{
  ...
  800b63:	e8 aa f6 ff ff       	call   800212 <sys_page_unmap>
  ...
  800b76:	e8 97 f6 ff ff       	call   800212 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800b99:	57                   	push   %edi
  800b9a:	e8 0d 10 00 00       	call   801bac <pageref>
  800b9f:	89 c6                	mov    %eax,%esi
  800ba1:	83 c4 04             	add    $0x4,%esp
  800ba4:	ff 75 e4             	pushl  -0x1c(%ebp)
  800ba7:	e8 00 10 00 00       	call   801bac <pageref>
  ...
  800bd6:	50                   	push   %eax
  800bd7:	53                   	push   %ebx
  800bd8:	68 3e 1f 80 00       	push   $0x801f3e
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800c16:	75 4d                	jne    800c65 <devpipe_write+0x7e>
			...
			sys_yield();
  800c18:	e8 84 f5 ff ff       	call   8001a1 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800ca5:	75 42                	jne    800ce9 <devpipe_read+0x77>
			...
			sys_yield();
  800ca7:	e8 f5 f4 ff ff       	call   8001a1 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  800d25:	e8 9e f4 ff ff       	call   8001c8 <sys_page_alloc>
  ...
  800d5d:	e8 66 f4 ff ff       	call   8001c8 <sys_page_alloc>
  ...
  800d87:	e8 3c f4 ff ff       	call   8001c8 <sys_page_alloc>
  ...
  800db1:	e8 36 f4 ff ff       	call   8001ec <sys_page_map>
  ...
  800e14:	e8 f9 f3 ff ff       	call   800212 <sys_page_unmap>
  ...
  800e24:	e8 e9 f3 ff ff       	call   800212 <sys_page_unmap>
  ...
  800e34:	e8 d9 f3 ff ff       	call   800212 <sys_page_unmap>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e8c:	68 56 1f 80 00       	push   $0x801f56
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  800ee2:	53                   	push   %ebx
  800ee3:	57                   	push   %edi
  800ee4:	e8 28 f2 ff ff       	call   800111 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  800f12:	eb 25                	jmp    800f39 <devcons_read+0x33>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  800f14:	e8 88 f2 ff ff       	call   8001a1 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  800f19:	e8 19 f2 ff ff       	call   800137 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  800f58:	50                   	push   %eax
  800f59:	e8 b3 f1 ff ff       	call   800111 <sys_cputs>
...
opencons(void)
{
  ...
  800fdd:	e8 e6 f1 ff ff       	call   8001c8 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80103b:	e8 53 00 00 00       	call   801093 <vcprintf>
	cprintf("\n");
  801040:	c7 04 24 4f 1f 80 00 	movl   $0x801f4f,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  80107c:	50                   	push   %eax
  80107d:	e8 8f f0 ff ff       	call   800111 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8010d6:	50                   	push   %eax
  8010d7:	e8 35 f0 ff ff       	call   800111 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80114c:	e8 9f 0a 00 00       	call   801bf0 <__udivdi3>
  ...
  801188:	e8 7f 0b 00 00       	call   801d0c <__umoddi3>
  80118d:	83 c4 14             	add    $0x14,%esp
  801190:	0f be 80 87 1f 80 00 	movsbl 0x801f87(%eax),%eax
  801197:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8012d4:	ff 24 85 c0 20 80 00 	jmp    *0x8020c0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  801380:	8b 04 85 20 22 80 00 	mov    0x802220(,%eax,4),%eax
  801387:	85 c0                	test   %eax,%eax
  801389:	75 1a                	jne    8013a5 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  80138b:	52                   	push   %edx
  80138c:	68 9f 1f 80 00       	push   $0x801f9f
  801391:	57                   	push   %edi
  ...
  8013a5:	50                   	push   %eax
  8013a6:	68 1d 1f 80 00       	push   $0x801f1d
  8013ab:	57                   	push   %edi
  ...
  8013da:	75 07                	jne    8013e3 <vprintfmt+0x19a>
				p = "(null)";
  8013dc:	c7 45 d0 98 1f 80 00 	movl   $0x801f98,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801a1e:	83 3d 00 60 80 00 00 	cmpl   $0x0,0x806000
  801a25:	75 52                	jne    801a79 <set_pgfault_handler+0x61>
		// First time through!	
		// LAB 4: Your code here.
  ...
  801a2c:	68 00 f0 bf ee       	push   $0xeebff000
  801a31:	6a 00                	push   $0x0
  801a33:	e8 90 e7 ff ff       	call   8001c8 <sys_page_alloc>
		if (r < 0) {
  801a38:	83 c4 10             	add    $0x10,%esp
  801a3b:	85 c0                	test   %eax,%eax
  801a3d:	79 12                	jns    801a51 <set_pgfault_handler+0x39>
			panic("sys_page_alloc error : %e\n", r);
  801a3f:	50                   	push   %eax
  801a40:	68 7f 22 80 00       	push   $0x80227f
  801a45:	6a 24                	push   $0x24
  801a47:	68 9a 22 80 00       	push   $0x80229a
  801a4c:	e8 bb f5 ff ff       	call   80100c <_panic>
		}

		// how to know envid, put 0, envid2env will help us to get curenv in syscall
		r = sys_env_set_pgfault_upcall(0, _pgfault_upcall);		
  801a51:	83 ec 08             	sub    $0x8,%esp
  801a54:	68 30 03 80 00       	push   $0x800330
  801a59:	6a 00                	push   $0x0
  801a5b:	e8 1b e8 ff ff       	call   80027b <sys_env_set_pgfault_upcall>
		if (r < 0) {
  801a60:	83 c4 10             	add    $0x10,%esp
  801a63:	85 c0                	test   %eax,%eax
  801a65:	79 12                	jns    801a79 <set_pgfault_handler+0x61>
			panic("sys_env_set_pgfault_upcall error : %e\n", r);
  801a67:	50                   	push   %eax
  801a68:	68 a8 22 80 00       	push   $0x8022a8
  801a6d:	6a 2a                	push   $0x2a
  801a6f:	68 9a 22 80 00       	push   $0x80229a
  801a74:	e8 93 f5 ff ff       	call   80100c <_panic>
		}
	}
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a99:	50                   	push   %eax
  801a9a:	e8 24 e8 ff ff       	call   8002c3 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b02:	8b 7d 0c             	mov    0xc(%ebp),%edi
  801b05:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801b08:	8b 75 14             	mov    0x14(%ebp),%esi
	// LAB 4: Your code here.
	// int sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
	int r;
	if (pg == NULL) pg = (void *)UTOP;
  801b0b:	85 db                	test   %ebx,%ebx
  801b0d:	75 25                	jne    801b34 <ipc_send+0x3b>
  801b0f:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
  801b14:	eb 1e                	jmp    801b34 <ipc_send+0x3b>
	
	while ((r = sys_ipc_try_send(to_env, val, pg, perm)) != 0) {
		if (r == -E_IPC_NOT_RECV) {
  801b16:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b19:	75 07                	jne    801b22 <ipc_send+0x29>
			// cprintf("Try Again and Again....\n");
			sys_yield();
  801b1b:	e8 81 e6 ff ff       	call   8001a1 <sys_yield>
  801b20:	eb 12                	jmp    801b34 <ipc_send+0x3b>
		} else {
			panic("ipc_send error %e\n", r);
  801b22:	50                   	push   %eax
  801b23:	68 d0 22 80 00       	push   $0x8022d0
  801b28:	6a 43                	push   $0x43
  801b2a:	68 e3 22 80 00       	push   $0x8022e3
  801b2f:	e8 d8 f4 ff ff       	call   80100c <_panic>
	// LAB 4: Your code here.
	// int sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
	int r;
	if (pg == NULL) pg = (void *)UTOP;
  ...
  801b3a:	e8 5f e7 ff ff       	call   80029e <sys_ipc_try_send>
  801b3f:	83 c4 10             	add    $0x10,%esp
  801b42:	85 c0                	test   %eax,%eax
  801b44:	75 d0                	jne    801b16 <ipc_send+0x1d>
		} else {
			panic("ipc_send error %e\n", r);
		}
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b55:	39 1d 50 00 c0 ee    	cmp    %ebx,0xeec00050
  801b5b:	74 22                	je     801b7f <ipc_find_env+0x31>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b5d:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  801b62:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  801b69:	89 c2                	mov    %eax,%edx
  801b6b:	c1 e2 07             	shl    $0x7,%edx
  801b6e:	29 ca                	sub    %ecx,%edx
  801b70:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801b76:	8b 52 50             	mov    0x50(%edx),%edx
  801b79:	39 da                	cmp    %ebx,%edx
  801b7b:	75 1d                	jne    801b9a <ipc_find_env+0x4c>
  801b7d:	eb 05                	jmp    801b84 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801b84:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801b8b:	c1 e0 07             	shl    $0x7,%eax
  801b8e:	29 d0                	sub    %edx,%eax
  801b90:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801b95:	8b 40 40             	mov    0x40(%eax),%eax
  801b98:	eb 0c                	jmp    801ba6 <ipc_find_env+0x58>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801ba0:	75 c0                	jne    801b62 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801ba2:	66 b8 00 00          	mov    $0x0,%ax
}
  801ba6:	5b                   	pop    %ebx
  801ba7:	c9                   	leave  
  801ba8:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801bb4:	c1 ea 16             	shr    $0x16,%edx
  801bb7:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  801bbe:	f6 c2 01             	test   $0x1,%dl
  801bc1:	74 1e                	je     801be1 <pageref+0x35>
		return 0;
	pte = uvpt[PGNUM(v)];
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  801bfe:	89 7d f0             	mov    %edi,-0x10(%ebp)
  801c01:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  801c04:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  801c0c:	75 2e                	jne    801c3c <__udivdi3+0x4c>
    {
      if (d0 > n1)
  801c0e:	39 f1                	cmp    %esi,%ecx
  801c10:	77 5a                	ja     801c6c <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
	  ...
	  if (d0 == 0)
  801c12:	85 c9                	test   %ecx,%ecx
  801c14:	75 0b                	jne    801c21 <__udivdi3+0x31>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  801c3e:	77 1c                	ja     801c5c <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  801c46:	75 3c                	jne    801c84 <__udivdi3+0x94>
  ...
  801c4a:	0f 82 90 00 00 00    	jb     801ce0 <__udivdi3+0xf0>
  801c50:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801c53:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  801c56:	0f 86 84 00 00 00    	jbe    801ce0 <__udivdi3+0xf0>
  801c5c:	31 f6                	xor    %esi,%esi
  801c5e:	31 ff                	xor    %edi,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  801c88:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  801c8b:	b8 20 00 00 00       	mov    $0x20,%eax
  801c90:	29 f8                	sub    %edi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  801c92:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801c95:	88 c1                	mov    %al,%cl
  801c97:	d3 ea                	shr    %cl,%edx
  801c99:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  801c9c:	09 ca                	or     %ecx,%edx
  801c9e:	89 55 ec             	mov    %edx,-0x14(%ebp)
	      d0 = d0 << bm;
  ...
  801cad:	88 c1                	mov    %al,%cl
  801caf:	d3 ea                	shr    %cl,%edx
  801cb1:	89 55 e8             	mov    %edx,-0x18(%ebp)
	      n1 = (n1 << bm) | (n0 >> b);
  801cb4:	89 f2                	mov    %esi,%edx
  801cb6:	89 f9                	mov    %edi,%ecx
  801cb8:	d3 e2                	shl    %cl,%edx
  801cba:	8b 75 f0             	mov    -0x10(%ebp),%esi
  801cbd:	88 c1                	mov    %al,%cl
  801cbf:	d3 ee                	shr    %cl,%esi
  801cc1:	09 d6                	or     %edx,%esi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  801cc3:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  801cc6:	89 f0                	mov    %esi,%eax
  801cc8:	89 ca                	mov    %ecx,%edx
  801cca:	f7 75 ec             	divl   -0x14(%ebp)
  801ccd:	89 d1                	mov    %edx,%ecx
  801ccf:	89 c6                	mov    %eax,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801cd1:	f7 65 f4             	mull   -0xc(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801cd4:	39 d1                	cmp    %edx,%ecx
  801cd6:	72 28                	jb     801d00 <__udivdi3+0x110>
  801cd8:	74 1a                	je     801cf4 <__udivdi3+0x104>
  801cda:	89 f7                	mov    %esi,%edi
  801cdc:	31 f6                	xor    %esi,%esi
  801cde:	eb 80                	jmp    801c60 <__udivdi3+0x70>
	      /* The condition on the next line takes advantage of that
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
		{
  ...
  801ce2:	bf 01 00 00 00       	mov    $0x1,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  801cfd:	73 db                	jae    801cda <__udivdi3+0xea>
  801cff:	90                   	nop
		{
		  q0--;
  801d00:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  801d03:	31 f6                	xor    %esi,%esi
  801d05:	e9 56 ff ff ff       	jmp    801c60 <__udivdi3+0x70>
	...
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  const DWunion dd = {.ll = d};
  801d20:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  801d2d:	75 15                	jne    801d44 <__umoddi3+0x38>
    {
      if (d0 > n1)
  801d2f:	39 f1                	cmp    %esi,%ecx
  801d31:	0f 86 99 00 00 00    	jbe    801dd0 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */
  ...
  801d43:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  801d44:	39 f7                	cmp    %esi,%edi
  801d46:	0f 87 a4 00 00 00    	ja     801df0 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  801d4c:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  801d4f:	83 f0 1f             	xor    $0x1f,%eax
  801d52:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801d55:	0f 84 a1 00 00 00    	je     801dfc <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  801d60:	d3 e0                	shl    %cl,%eax
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  801d62:	bf 20 00 00 00       	mov    $0x20,%edi
  801d67:	2b 7d ec             	sub    -0x14(%ebp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  801d6a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801d6d:	89 f9                	mov    %edi,%ecx
  801d6f:	d3 ea                	shr    %cl,%edx
  801d71:	09 c2                	or     %eax,%edx
  801d73:	89 55 f0             	mov    %edx,-0x10(%ebp)
	      d0 = d0 << bm;
  801d76:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d79:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  801d9d:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801d9f:	f7 65 f4             	mull   -0xc(%ebp)
  801da2:	89 55 e8             	mov    %edx,-0x18(%ebp)
  801da5:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801da7:	39 d6                	cmp    %edx,%esi
  801da9:	72 71                	jb     801e1c <__umoddi3+0x110>
  801dab:	74 7f                	je     801e2c <__umoddi3+0x120>
	      q1 = 0;
  ...
  801db0:	29 c8                	sub    %ecx,%eax
  801db2:	19 d6                	sbb    %edx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  801db4:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  801dc3:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  801dd2:	75 0b                	jne    801ddf <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  801de3:	f7 f1                	div    %ecx
	  udiv_qrnnd (q0, n0, n1, n0, d0);
  801de5:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801de8:	f7 f1                	div    %ecx
  801dea:	e9 4a ff ff ff       	jmp    801d39 <__umoddi3+0x2d>
  801def:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  801dfe:	72 05                	jb     801e05 <__umoddi3+0xf9>
  801e00:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  801e03:	77 0c                	ja     801e11 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  801e05:	89 f2                	mov    %esi,%edx
  801e07:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e0a:	29 c8                	sub    %ecx,%eax
  801e0c:	19 fa                	sbb    %edi,%edx
  801e0e:	89 45 f0             	mov    %eax,-0x10(%ebp)
  ...
  801e21:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  801e24:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  801e27:	eb 84                	jmp    801dad <__umoddi3+0xa1>
  ...
  801e2f:	72 eb                	jb     801e1c <__umoddi3+0x110>
  801e31:	89 f2                	mov    %esi,%edx
  801e33:	e9 75 ff ff ff       	jmp    801dad <__umoddi3+0xa1>
