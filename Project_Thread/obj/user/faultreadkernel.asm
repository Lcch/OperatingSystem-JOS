	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f4:	0f be 80 11 1e 80 00 	movsbl 0x801e11(%eax),%eax
  8001fb:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800338:	ff 24 85 60 1f 80 00 	jmp    *0x801f60(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003e4:	8b 04 85 c0 20 80 00 	mov    0x8020c0(,%eax,4),%eax
  8003eb:	85 c0                	test   %eax,%eax
  8003ed:	75 1a                	jne    800409 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003ef:	52                   	push   %edx
  8003f0:	68 29 1e 80 00       	push   $0x801e29
  8003f5:	57                   	push   %edi
  ...
  800409:	50                   	push   %eax
  80040a:	68 f1 21 80 00       	push   $0x8021f1
  80040f:	57                   	push   %edi
  ...
  80043e:	75 07                	jne    800447 <vprintfmt+0x19a>
				p = "(null)";
  800440:	c7 45 d0 22 1e 80 00 	movl   $0x801e22,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aae:	68 1f 21 80 00       	push   $0x80211f
  800ab3:	6a 42                	push   $0x42
  800ab5:	68 3c 21 80 00       	push   $0x80213c
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e4d:	40                   	inc    %eax
  800e4e:	8b 14 85 c8 21 80 00 	mov    0x8021c8(,%eax,4),%edx
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801094:	53                   	push   %ebx
  801095:	50                   	push   %eax
  801096:	68 8d 21 80 00       	push   $0x80218d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80116b:	53                   	push   %ebx
  80116c:	50                   	push   %eax
  80116d:	68 a9 21 80 00       	push   $0x8021a9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801216:	53                   	push   %ebx
  801217:	50                   	push   %eax
  801218:	68 6c 21 80 00       	push   $0x80216c
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015aa:	50                   	push   %eax
  8015ab:	53                   	push   %ebx
  8015ac:	68 12 22 80 00       	push   $0x802212
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801860:	68 2a 22 80 00       	push   $0x80222a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019fc:	53                   	push   %ebx
  8019fd:	50                   	push   %eax
  8019fe:	68 38 22 80 00       	push   $0x802238
  ...
  801a0f:	e8 e3 e6 ff ff       	call   8000f7 <vcprintf>
	cprintf("\n");
  801a14:	c7 04 24 23 22 80 00 	movl   $0x802223,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ac6:	50                   	push   %eax
  801ac7:	68 5c 22 80 00       	push   $0x80225c
  801acc:	6a 43                	push   $0x43
  801ace:	68 6f 22 80 00       	push   $0x80226f
