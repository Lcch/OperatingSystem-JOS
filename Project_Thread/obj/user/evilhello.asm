...
umain(int argc, char **argv)
{
  ...
  800041:	e8 bb 00 00 00       	call   800101 <sys_cputs>
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800485:	40                   	inc    %eax
  800486:	8b 14 85 94 1e 80 00 	mov    0x801e94(,%eax,4),%edx
  ...
  80049c:	51                   	push   %ecx
  80049d:	50                   	push   %eax
  80049e:	68 18 1e 80 00       	push   $0x801e18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006cc:	53                   	push   %ebx
  8006cd:	50                   	push   %eax
  8006ce:	68 59 1e 80 00       	push   $0x801e59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007a3:	53                   	push   %ebx
  8007a4:	50                   	push   %eax
  8007a5:	68 75 1e 80 00       	push   $0x801e75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80084e:	53                   	push   %ebx
  80084f:	50                   	push   %eax
  800850:	68 38 1e 80 00       	push   $0x801e38
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b2c:	68 d7 1e 80 00       	push   $0x801ed7
  800b31:	56                   	push   %esi
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800be2:	50                   	push   %eax
  800be3:	53                   	push   %ebx
  800be4:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e98:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801034:	53                   	push   %ebx
  801035:	50                   	push   %eax
  801036:	68 04 1f 80 00       	push   $0x801f04
  ...
  801047:	e8 53 00 00 00       	call   80109f <vcprintf>
	cprintf("\n");
  80104c:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80119c:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  8011a3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801397:	52                   	push   %edx
  801398:	68 3f 1f 80 00       	push   $0x801f3f
  80139d:	57                   	push   %edi
  ...
  8013b1:	50                   	push   %eax
  8013b2:	68 bd 1e 80 00       	push   $0x801ebd
  8013b7:	57                   	push   %edi
  ...
  8013e6:	75 07                	jne    8013ef <vprintfmt+0x19a>
				p = "(null)";
  8013e8:	c7 45 d0 38 1f 80 00 	movl   $0x801f38,-0x30(%ebp)
			if (width > 0 && padc != '-')
