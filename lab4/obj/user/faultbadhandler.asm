...
umain(int argc, char **argv)
{
  ...
  800043:	e8 88 01 00 00       	call   8001d0 <sys_page_alloc>
	sys_env_set_pgfault_upcall(0, (void*) 0xDeadBeef);
  800048:	83 c4 08             	add    $0x8,%esp
  80004b:	68 ef be ad de       	push   $0xdeadbeef
  800050:	6a 00                	push   $0x0
  800052:	e8 09 02 00 00       	call   800260 <sys_env_set_pgfault_upcall>
	*(int*)0 = 0;
...
libmain(int argc, char **argv)
{
  ...
  800073:	e8 0d 01 00 00       	call   800185 <sys_getenvid>
...
exit(void)
{
  ...
  8000c0:	e8 9e 00 00 00       	call   800163 <sys_env_destroy>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000d0:	56                   	push   %esi
  8000d1:	53                   	push   %ebx
  8000d2:	83 ec 1c             	sub    $0x1c,%esp
  8000d5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8000d8:	89 55 e0             	mov    %edx,-0x20(%ebp)
  8000db:	89 ca                	mov    %ecx,%edx
	//
	...
	asm volatile("int %1\n"
  8000dd:	8b 75 14             	mov    0x14(%ebp),%esi
  ...
  8000eb:	89 c2                	mov    %eax,%edx
	...
	if(check && ret > 0)
  8000ed:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8000f1:	74 1c                	je     80010f <syscall+0x43>
  8000f3:	85 c0                	test   %eax,%eax
  8000f5:	7e 18                	jle    80010f <syscall+0x43>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000f7:	83 ec 0c             	sub    $0xc,%esp
  8000fa:	50                   	push   %eax
  8000fb:	ff 75 e4             	pushl  -0x1c(%ebp)
  8000fe:	68 2a 0f 80 00       	push   $0x800f2a
  800103:	6a 42                	push   $0x42
  800105:	68 47 0f 80 00       	push   $0x800f47
  80010a:	e8 bd 01 00 00       	call   8002cc <_panic>
...
{	
  ...
  800135:	e8 92 ff ff ff       	call   8000cc <syscall>
...
sys_cgetc(void)
{
  ...
  800157:	b8 01 00 00 00       	mov    $0x1,%eax
  80015c:	e8 6b ff ff ff       	call   8000cc <syscall>
}
  800161:	c9                   	leave  
  800162:	c3                   	ret    

00800163 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  80017e:	e8 49 ff ff ff       	call   8000cc <syscall>
}
  800183:	c9                   	leave  
  800184:	c3                   	ret    
...
sys_getenvid(void)
{
  ...
  8001a2:	e8 25 ff ff ff       	call   8000cc <syscall>
}
  8001a7:	c9                   	leave  
  8001a8:	c3                   	ret    
...
sys_yield(void)
{
  ...
  8001c6:	e8 01 ff ff ff       	call   8000cc <syscall>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001e3:	ba 01 00 00 00       	mov    $0x1,%edx
  8001e8:	b8 04 00 00 00       	mov    $0x4,%eax
  8001ed:	e8 da fe ff ff       	call   8000cc <syscall>
}
  8001f2:	c9                   	leave  
  8001f3:	c3                   	ret    
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fd:	ff 75 14             	pushl  0x14(%ebp)
  ...
  800213:	e8 b4 fe ff ff       	call   8000cc <syscall>
}
  800218:	c9                   	leave  
  800219:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800236:	e8 91 fe ff ff       	call   8000cc <syscall>
}
  80023b:	c9                   	leave  
  80023c:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800259:	e8 6e fe ff ff       	call   8000cc <syscall>
}
  80025e:	c9                   	leave  
  80025f:	c3                   	ret    
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800272:	ba 01 00 00 00       	mov    $0x1,%edx
  800277:	b8 09 00 00 00       	mov    $0x9,%eax
  80027c:	e8 4b fe ff ff       	call   8000cc <syscall>
}
  800281:	c9                   	leave  
  800282:	c3                   	ret    

00800283 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80028b:	ff 75 14             	pushl  0x14(%ebp)
  ...
  8002a1:	e8 26 fe ff ff       	call   8000cc <syscall>
}
  8002a6:	c9                   	leave  
  8002a7:	c3                   	ret    

008002a8 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8002b9:	ba 01 00 00 00       	mov    $0x1,%edx
  8002be:	b8 0c 00 00 00       	mov    $0xc,%eax
  8002c3:	e8 04 fe ff ff       	call   8000cc <syscall>
}
  8002c8:	c9                   	leave  
  8002c9:	c3                   	ret    
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002da:	e8 a6 fe ff ff       	call   800185 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  80033c:	50                   	push   %eax
  80033d:	e8 d7 fd ff ff       	call   800119 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800396:	50                   	push   %eax
  800397:	e8 7d fd ff ff       	call   800119 <sys_cputs>
