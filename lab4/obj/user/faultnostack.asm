...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000ee:	68 6a 0f 80 00       	push   $0x800f6a
  8000f3:	6a 42                	push   $0x42
  8000f5:	68 87 0f 80 00       	push   $0x800f87
  8000fa:	e8 c9 01 00 00       	call   8002c8 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002d6:	e8 9a fe ff ff       	call   800175 <sys_getenvid>
  8002db:	83 ec 0c             	sub    $0xc,%esp
  8002de:	ff 75 0c             	pushl  0xc(%ebp)
  8002e1:	ff 75 08             	pushl  0x8(%ebp)
  8002e4:	53                   	push   %ebx
  8002e5:	50                   	push   %eax
  8002e6:	68 98 0f 80 00       	push   $0x800f98
  ...
  8002f7:	e8 53 00 00 00       	call   80034f <vcprintf>
	cprintf("\n");
  8002fc:	c7 04 24 bb 0f 80 00 	movl   $0x800fbb,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800338:	50                   	push   %eax
  800339:	e8 cb fd ff ff       	call   800109 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800392:	50                   	push   %eax
  800393:	e8 71 fd ff ff       	call   800109 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800408:	e8 f7 08 00 00       	call   800d04 <__udivdi3>
  ...
  800444:	e8 d7 09 00 00       	call   800e20 <__umoddi3>
  800449:	83 c4 14             	add    $0x14,%esp
  80044c:	0f be 80 bd 0f 80 00 	movsbl 0x800fbd(%eax),%eax
  800453:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80063c:	8b 04 85 e0 11 80 00 	mov    0x8011e0(,%eax,4),%eax
  800643:	85 c0                	test   %eax,%eax
  800645:	75 1a                	jne    800661 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  800647:	52                   	push   %edx
  800648:	68 d5 0f 80 00       	push   $0x800fd5
  80064d:	57                   	push   %edi
  ...
  800661:	50                   	push   %eax
  800662:	68 de 0f 80 00       	push   $0x800fde
  800667:	57                   	push   %edi
  ...
  800696:	75 07                	jne    80069f <vprintfmt+0x19a>
				p = "(null)";
  800698:	c7 45 d0 ce 0f 80 00 	movl   $0x800fce,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800cda:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800ce1:	75 14                	jne    800cf7 <set_pgfault_handler+0x23>
		// First time through!
		// LAB 4: Your code here.
		panic("set_pgfault_handler not implemented");
  800ce3:	83 ec 04             	sub    $0x4,%esp
  800ce6:	68 04 12 80 00       	push   $0x801204
  800ceb:	6a 20                	push   $0x20
  800ced:	68 28 12 80 00       	push   $0x801228
  800cf2:	e8 d1 f5 ff ff       	call   8002c8 <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800cf7:	8b 45 08             	mov    0x8(%ebp),%eax
  800cfa:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800cff:	c9                   	leave  
  800d00:	c3                   	ret    
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800d12:	89 7d f0             	mov    %edi,-0x10(%ebp)
  ...
  800d20:	75 2e                	jne    800d50 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800d22:	39 f1                	cmp    %esi,%ecx
  800d24:	77 5a                	ja     800d80 <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800d28:	75 0b                	jne    800d35 <__udivdi3+0x31>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  800d2a:	b8 01 00 00 00       	mov    $0x1,%eax
  800d2f:	31 d2                	xor    %edx,%edx
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800d4e:	66 90                	xchg   %ax,%ax
    ...
    {
      if (d1 > n1)
  800d50:	39 f0                	cmp    %esi,%eax
  800d52:	77 1c                	ja     800d70 <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800d54:	0f bd f8             	bsr    %eax,%edi
	  if (bm == 0)
  800d57:	83 f7 1f             	xor    $0x1f,%edi
  800d5a:	75 3c                	jne    800d98 <__udivdi3+0x94>
  ...
  800d5e:	0f 82 90 00 00 00    	jb     800df4 <__udivdi3+0xf0>
  800d64:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800d67:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  800d6a:	0f 86 84 00 00 00    	jbe    800df4 <__udivdi3+0xf0>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800d9c:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800d9f:	b8 20 00 00 00       	mov    $0x20,%eax
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e06:	66 90                	xchg   %ax,%ax
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800e08:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800e0b:	89 f9                	mov    %edi,%ecx
  800e0d:	d3 e2                	shl    %cl,%edx
  ...
  800e11:	73 db                	jae    800dee <__udivdi3+0xea>
  800e13:	90                   	nop
		{
		  q0--;
  800e14:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800e17:	31 f6                	xor    %esi,%esi
  800e19:	e9 56 ff ff ff       	jmp    800d74 <__udivdi3+0x70>
	...
...
{
  const DWunion nn = {.ll = n};
  800e2e:	89 45 e8             	mov    %eax,-0x18(%ebp)
  800e31:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800e34:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800e41:	75 15                	jne    800e58 <__umoddi3+0x38>
    {
      if (d0 > n1)
  800e43:	39 f1                	cmp    %esi,%ecx
  800e45:	0f 86 99 00 00 00    	jbe    800ee4 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */
  ...
  800e57:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800e58:	39 f7                	cmp    %esi,%edi
  800e5a:	0f 87 a4 00 00 00    	ja     800f04 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800e60:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  800e63:	83 f0 1f             	xor    $0x1f,%eax
  800e66:	89 45 ec             	mov    %eax,-0x14(%ebp)
  800e69:	0f 84 a1 00 00 00    	je     800f10 <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800e71:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  800e7b:	2b 7d ec             	sub    -0x14(%ebp),%edi
  ...
  800e87:	89 55 f0             	mov    %edx,-0x10(%ebp)
	      d0 = d0 << bm;
  800e8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800e8d:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800e90:	d3 e0                	shl    %cl,%eax
  ...
  800e97:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800e99:	8b 45 e8             	mov    -0x18(%ebp),%eax
  ...
  800ea6:	d3 e8                	shr    %cl,%eax
  800ea8:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800eaa:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800eac:	89 f2                	mov    %esi,%edx
  800eae:	f7 75 f0             	divl   -0x10(%ebp)
  800eb1:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800eb3:	f7 65 f4             	mull   -0xc(%ebp)
  800eb6:	89 55 e8             	mov    %edx,-0x18(%ebp)
  800eb9:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800ebb:	39 d6                	cmp    %edx,%esi
  800ebd:	72 71                	jb     800f30 <__umoddi3+0x110>
  800ebf:	74 7f                	je     800f40 <__umoddi3+0x120>
	      q1 = 0;
  ...
  800ec1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  800ec4:	29 c8                	sub    %ecx,%eax
  800ec6:	19 d6                	sbb    %edx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  800ec8:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800ecb:	d3 e8                	shr    %cl,%eax
  800ecd:	89 f2                	mov    %esi,%edx
  800ecf:	89 f9                	mov    %edi,%ecx
  800ed1:	d3 e2                	shl    %cl,%edx
		  rr.s.high = n1 >> bm;
		  *rp = rr.ll;
  800ed3:	09 d0                	or     %edx,%eax
  800ed5:	89 f2                	mov    %esi,%edx
  800ed7:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800eda:	d3 ea                	shr    %cl,%edx
  UDWtype w;
  ...
  800ee6:	75 0b                	jne    800ef3 <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  800efe:	e9 4a ff ff ff       	jmp    800e4d <__umoddi3+0x2d>
  800f03:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  800f12:	72 05                	jb     800f19 <__umoddi3+0xf9>
  800f14:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  800f17:	77 0c                	ja     800f25 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f19:	89 f2                	mov    %esi,%edx
  800f1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  800f1e:	29 c8                	sub    %ecx,%eax
  ...
  800f2f:	90                   	nop
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
		{
		  q0--;
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f30:	8b 55 e8             	mov    -0x18(%ebp),%edx
  800f33:	89 c1                	mov    %eax,%ecx
  800f35:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  800f38:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  800f3b:	eb 84                	jmp    800ec1 <__umoddi3+0xa1>
  800f3d:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800f40:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  800f43:	72 eb                	jb     800f30 <__umoddi3+0x110>
  800f45:	89 f2                	mov    %esi,%edx
  800f47:	e9 75 ff ff ff       	jmp    800ec1 <__umoddi3+0xa1>
