...
umain(int argc, char **argv)
{
  ...
  800041:	0f 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 3c 01 00 00       	call   800185 <sys_yield>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000da:	68 2f 0f 80 00       	push   $0x800f2f
  8000df:	6a 42                	push   $0x42
  8000e1:	68 4c 0f 80 00       	push   $0x800f4c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002e8:	53                   	push   %ebx
  8002e9:	50                   	push   %eax
  8002ea:	68 5c 0f 80 00       	push   $0x800f5c
  ...
  8002fb:	e8 53 00 00 00       	call   800353 <vcprintf>
	cprintf("\n");
  800300:	c7 04 24 80 0f 80 00 	movl   $0x800f80,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800450:	0f be 80 82 0f 80 00 	movsbl 0x800f82(%eax),%eax
  800457:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80064b:	52                   	push   %edx
  80064c:	68 9a 0f 80 00       	push   $0x800f9a
  800651:	57                   	push   %edi
  ...
  800665:	50                   	push   %eax
  800666:	68 a3 0f 80 00       	push   $0x800fa3
  80066b:	57                   	push   %edi
  ...
  80069a:	75 07                	jne    8006a3 <vprintfmt+0x19a>
				p = "(null)";
  80069c:	c7 45 d0 93 0f 80 00 	movl   $0x800f93,-0x30(%ebp)
			if (width > 0 && padc != '-')
