...
umain(int argc, char **argv)
{
  ...
  800041:	0f 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 44 01 00 00       	call   80018d <sys_yield>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000e2:	68 2f 0f 80 00       	push   $0x800f2f
  8000e7:	6a 42                	push   $0x42
  8000e9:	68 4c 0f 80 00       	push   $0x800f4c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002cc:	53                   	push   %ebx
  8002cd:	50                   	push   %eax
  8002ce:	68 5c 0f 80 00       	push   $0x800f5c
  ...
  8002df:	e8 53 00 00 00       	call   800337 <vcprintf>
	cprintf("\n");
  8002e4:	c7 04 24 80 0f 80 00 	movl   $0x800f80,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800434:	0f be 80 82 0f 80 00 	movsbl 0x800f82(%eax),%eax
  80043b:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80062f:	52                   	push   %edx
  800630:	68 9a 0f 80 00       	push   $0x800f9a
  800635:	57                   	push   %edi
  ...
  800649:	50                   	push   %eax
  80064a:	68 a3 0f 80 00       	push   $0x800fa3
  80064f:	57                   	push   %edi
  ...
  80067e:	75 07                	jne    800687 <vprintfmt+0x19a>
				p = "(null)";
  800680:	c7 45 d0 93 0f 80 00 	movl   $0x800f93,-0x30(%ebp)
			if (width > 0 && padc != '-')
