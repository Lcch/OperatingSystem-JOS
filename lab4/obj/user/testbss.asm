...
umain(int argc, char **argv)
{
  ...
  80003f:	e8 f0 01 00 00       	call   800234 <cprintf>
...
umain(int argc, char **argv)
{
  ...
  800066:	50                   	push   %eax
  800067:	68 3b 10 80 00       	push   $0x80103b
  80006c:	6a 11                	push   $0x11
  80006e:	68 58 10 80 00       	push   $0x801058
  800073:	e8 e4 00 00 00       	call   80015c <_panic>
umain(int argc, char **argv)
{
	int i;
  ...
  8000b2:	50                   	push   %eax
  8000b3:	68 e0 0f 80 00       	push   $0x800fe0
  8000b8:	6a 16                	push   $0x16
  8000ba:	68 58 10 80 00       	push   $0x801058
  ...
  8000cf:	68 08 10 80 00       	push   $0x801008
  8000d4:	e8 5b 01 00 00       	call   800234 <cprintf>
	bigarray[ARRAYSIZE+1024] = 0;
  8000d9:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8000e0:	00 00 00 
	panic("SHOULD HAVE TRAPPED!!!");
  8000e3:	83 c4 0c             	add    $0xc,%esp
  8000e6:	68 67 10 80 00       	push   $0x801067
  8000eb:	6a 1a                	push   $0x1a
  8000ed:	68 58 10 80 00       	push   $0x801058
  8000f2:	e8 65 00 00 00       	call   80015c <_panic>
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800178:	53                   	push   %ebx
  800179:	50                   	push   %eax
  80017a:	68 88 10 80 00       	push   $0x801088
  ...
  80018b:	e8 53 00 00 00       	call   8001e3 <vcprintf>
	cprintf("\n");
  800190:	c7 04 24 56 10 80 00 	movl   $0x801056,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80029c:	e8 c7 0a 00 00       	call   800d68 <__udivdi3>
  ...
  8002d8:	e8 a7 0b 00 00       	call   800e84 <__umoddi3>
  8002dd:	83 c4 14             	add    $0x14,%esp
  8002e0:	0f be 80 ac 10 80 00 	movsbl 0x8010ac(%eax),%eax
  8002e7:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800424:	ff 24 85 80 11 80 00 	jmp    *0x801180(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004d0:	8b 04 85 e0 12 80 00 	mov    0x8012e0(,%eax,4),%eax
  8004d7:	85 c0                	test   %eax,%eax
  8004d9:	75 1a                	jne    8004f5 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8004db:	52                   	push   %edx
  8004dc:	68 c4 10 80 00       	push   $0x8010c4
  8004e1:	57                   	push   %edi
  ...
  8004f5:	50                   	push   %eax
  8004f6:	68 cd 10 80 00       	push   $0x8010cd
  8004fb:	57                   	push   %edi
  ...
  80052a:	75 07                	jne    800533 <vprintfmt+0x19a>
				p = "(null)";
  80052c:	c7 45 d0 bd 10 80 00 	movl   $0x8010bd,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b9a:	68 04 13 80 00       	push   $0x801304
  800b9f:	6a 42                	push   $0x42
  800ba1:	68 21 13 80 00       	push   $0x801321
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800d76:	89 7d f0             	mov    %edi,-0x10(%ebp)
  800d79:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800d7c:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800d84:	75 2e                	jne    800db4 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800d86:	39 f1                	cmp    %esi,%ecx
  800d88:	77 5a                	ja     800de4 <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800d8c:	75 0b                	jne    800d99 <__udivdi3+0x31>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800db6:	77 1c                	ja     800dd4 <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800db8:	0f bd f8             	bsr    %eax,%edi
	  if (bm == 0)
  800dbb:	83 f7 1f             	xor    $0x1f,%edi
  800dbe:	75 3c                	jne    800dfc <__udivdi3+0x94>
  ...
  800dc2:	0f 82 90 00 00 00    	jb     800e58 <__udivdi3+0xf0>
  800dc8:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800dcb:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  800dce:	0f 86 84 00 00 00    	jbe    800e58 <__udivdi3+0xf0>
  800dd4:	31 f6                	xor    %esi,%esi
  800dd6:	31 ff                	xor    %edi,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800df9:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800dfc:	89 f9                	mov    %edi,%ecx
  800dfe:	d3 e0                	shl    %cl,%eax
  800e00:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800e08:	29 f8                	sub    %edi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800e0a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800e0d:	88 c1                	mov    %al,%cl
  800e0f:	d3 ea                	shr    %cl,%edx
  800e11:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800e14:	09 ca                	or     %ecx,%edx
  800e16:	89 55 ec             	mov    %edx,-0x14(%ebp)
	      d0 = d0 << bm;
  ...
  800e29:	89 55 e8             	mov    %edx,-0x18(%ebp)
	      n1 = (n1 << bm) | (n0 >> b);
  800e2c:	89 f2                	mov    %esi,%edx
  800e2e:	89 f9                	mov    %edi,%ecx
  800e30:	d3 e2                	shl    %cl,%edx
  800e32:	8b 75 f0             	mov    -0x10(%ebp),%esi
  800e35:	88 c1                	mov    %al,%cl
  800e37:	d3 ee                	shr    %cl,%esi
  800e39:	09 d6                	or     %edx,%esi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800e3b:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800e3e:	89 f0                	mov    %esi,%eax
  800e40:	89 ca                	mov    %ecx,%edx
  800e42:	f7 75 ec             	divl   -0x14(%ebp)
  800e45:	89 d1                	mov    %edx,%ecx
  800e47:	89 c6                	mov    %eax,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800e49:	f7 65 f4             	mull   -0xc(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800e4c:	39 d1                	cmp    %edx,%ecx
  800e4e:	72 28                	jb     800e78 <__udivdi3+0x110>
  800e50:	74 1a                	je     800e6c <__udivdi3+0x104>
  800e52:	89 f7                	mov    %esi,%edi
  800e54:	31 f6                	xor    %esi,%esi
  800e56:	eb 80                	jmp    800dd8 <__udivdi3+0x70>
	      /* The condition on the next line takes advantage of that
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
		{
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e75:	73 db                	jae    800e52 <__udivdi3+0xea>
  800e77:	90                   	nop
		{
		  q0--;
  800e78:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800e7b:	31 f6                	xor    %esi,%esi
  800e7d:	e9 56 ff ff ff       	jmp    800dd8 <__udivdi3+0x70>
	...
...
{
  const DWunion nn = {.ll = n};
  800e92:	89 45 e8             	mov    %eax,-0x18(%ebp)
  800e95:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800e98:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800ea5:	75 15                	jne    800ebc <__umoddi3+0x38>
    {
      if (d0 > n1)
  800ea7:	39 f1                	cmp    %esi,%ecx
  800ea9:	0f 86 99 00 00 00    	jbe    800f48 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */
  ...
  800ebe:	0f 87 a4 00 00 00    	ja     800f68 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800ec4:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  800ec7:	83 f0 1f             	xor    $0x1f,%eax
  800eca:	89 45 ec             	mov    %eax,-0x14(%ebp)
  800ecd:	0f 84 a1 00 00 00    	je     800f74 <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800ed5:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800ed8:	d3 e0                	shl    %cl,%eax
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800edf:	2b 7d ec             	sub    -0x14(%ebp),%edi
  ...
  800eeb:	89 55 f0             	mov    %edx,-0x10(%ebp)
	      d0 = d0 << bm;
  ...
  800efb:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800efd:	8b 45 e8             	mov    -0x18(%ebp),%eax
  800f00:	d3 e0                	shl    %cl,%eax
  800f02:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800f05:	8b 45 e8             	mov    -0x18(%ebp),%eax
  800f08:	89 f9                	mov    %edi,%ecx
  ...
  800f0c:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800f0e:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f10:	89 f2                	mov    %esi,%edx
  800f12:	f7 75 f0             	divl   -0x10(%ebp)
  800f15:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800f17:	f7 65 f4             	mull   -0xc(%ebp)
  800f1a:	89 55 e8             	mov    %edx,-0x18(%ebp)
  800f1d:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800f1f:	39 d6                	cmp    %edx,%esi
  800f21:	72 71                	jb     800f94 <__umoddi3+0x110>
  800f23:	74 7f                	je     800fa4 <__umoddi3+0x120>
	      q1 = 0;
  ...
  800f25:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  800f28:	29 c8                	sub    %ecx,%eax
  800f2a:	19 d6                	sbb    %edx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  800f2c:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  800f3b:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800f3e:	d3 ea                	shr    %cl,%edx
  UDWtype w;
  ...
  800f4a:	75 0b                	jne    800f57 <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  800f62:	e9 4a ff ff ff       	jmp    800eb1 <__umoddi3+0x2d>
  800f67:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  800f76:	72 05                	jb     800f7d <__umoddi3+0xf9>
  800f78:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  800f7b:	77 0c                	ja     800f89 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f7d:	89 f2                	mov    %esi,%edx
  800f7f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  800f82:	29 c8                	sub    %ecx,%eax
  800f84:	19 fa                	sbb    %edi,%edx
  ...
  800f93:	90                   	nop
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
		{
		  q0--;
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f94:	8b 55 e8             	mov    -0x18(%ebp),%edx
  800f97:	89 c1                	mov    %eax,%ecx
  800f99:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  800f9c:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  800f9f:	eb 84                	jmp    800f25 <__umoddi3+0xa1>
  800fa1:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800fa4:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  800fa7:	72 eb                	jb     800f94 <__umoddi3+0x110>
  800fa9:	89 f2                	mov    %esi,%edx
  800fab:	e9 75 ff ff ff       	jmp    800f25 <__umoddi3+0xa1>
