...
libmain(int argc, char **argv)
{
  ...
  80006b:	e8 d1 0a 00 00       	call   800b41 <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001bc:	e8 0f 0b 00 00       	call   800cd0 <__udivdi3>
  ...
  8001f8:	e8 ef 0b 00 00       	call   800dec <__umoddi3>
  8001fd:	83 c4 14             	add    $0x14,%esp
  800200:	0f be 80 4f 0f 80 00 	movsbl 0x800f4f(%eax),%eax
  800207:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800344:	ff 24 85 20 10 80 00 	jmp    *0x801020(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003eb:	83 f8 08             	cmp    $0x8,%eax
  8003ee:	7f 0b                	jg     8003fb <vprintfmt+0x142>
  8003f0:	8b 04 85 80 11 80 00 	mov    0x801180(,%eax,4),%eax
  8003f7:	85 c0                	test   %eax,%eax
  8003f9:	75 1a                	jne    800415 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003fb:	52                   	push   %edx
  8003fc:	68 67 0f 80 00       	push   $0x800f67
  800401:	57                   	push   %edi
  ...
  800415:	50                   	push   %eax
  800416:	68 70 0f 80 00       	push   $0x800f70
  80041b:	57                   	push   %edi
  ...
  80044a:	75 07                	jne    800453 <vprintfmt+0x19a>
				p = "(null)";
  80044c:	c7 45 d0 60 0f 80 00 	movl   $0x800f60,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aba:	68 a4 11 80 00       	push   $0x8011a4
  800abf:	6a 42                	push   $0x42
  800ac1:	68 c1 11 80 00       	push   $0x8011c1
  800ac6:	e8 bd 01 00 00       	call   800c88 <_panic>
...
sys_yield(void)
{
  ...
  800b82:	e8 01 ff ff ff       	call   800a88 <syscall>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b9f:	ba 01 00 00 00       	mov    $0x1,%edx
  800ba4:	b8 04 00 00 00       	mov    $0x4,%eax
  800ba9:	e8 da fe ff ff       	call   800a88 <syscall>
}
  800bae:	c9                   	leave  
  800baf:	c3                   	ret    
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bb6:	ff 75 18             	pushl  0x18(%ebp)
  ...
  800bcf:	e8 b4 fe ff ff       	call   800a88 <syscall>
}
  800bd4:	c9                   	leave  
  800bd5:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bf2:	e8 91 fe ff ff       	call   800a88 <syscall>
}
  800bf7:	c9                   	leave  
  800bf8:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c15:	e8 6e fe ff ff       	call   800a88 <syscall>
}
  800c1a:	c9                   	leave  
  800c1b:	c3                   	ret    
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c38:	e8 4b fe ff ff       	call   800a88 <syscall>
}
  800c3d:	c9                   	leave  
  800c3e:	c3                   	ret    

00800c3f <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800c58:	b8 0b 00 00 00       	mov    $0xb,%eax
  800c5d:	e8 26 fe ff ff       	call   800a88 <syscall>
}
  800c62:	c9                   	leave  
  800c63:	c3                   	ret    
...
sys_ipc_recv(void *dstva)
{
  ...
  800c7a:	b8 0c 00 00 00       	mov    $0xc,%eax
  800c7f:	e8 04 fe ff ff       	call   800a88 <syscall>
}
  800c84:	c9                   	leave  
  800c85:	c3                   	ret    
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c8c:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800c8d:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800c90:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800c96:	e8 a6 fe ff ff       	call   800b41 <sys_getenvid>
  800c9b:	83 ec 0c             	sub    $0xc,%esp
  800c9e:	ff 75 0c             	pushl  0xc(%ebp)
  800ca1:	ff 75 08             	pushl  0x8(%ebp)
  800ca4:	53                   	push   %ebx
  800ca5:	50                   	push   %eax
  800ca6:	68 d0 11 80 00       	push   $0x8011d0
  800cab:	e8 a4 f4 ff ff       	call   800154 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800cb0:	83 c4 18             	add    $0x18,%esp
  800cb3:	56                   	push   %esi
  800cb4:	ff 75 10             	pushl  0x10(%ebp)
  800cb7:	e8 47 f4 ff ff       	call   800103 <vcprintf>
	cprintf("\n");
  800cbc:	c7 04 24 2c 0f 80 00 	movl   $0x800f2c,(%esp)
  800cc3:	e8 8c f4 ff ff       	call   800154 <cprintf>
