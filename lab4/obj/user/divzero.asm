...
umain(int argc, char **argv)
{
  ...
  800051:	50                   	push   %eax
  800052:	68 40 0f 80 00       	push   $0x800f40
  800057:	e8 f4 00 00 00       	call   800150 <cprintf>
...
libmain(int argc, char **argv)
{
  ...
  80006f:	e8 c9 0a 00 00       	call   800b3d <sys_getenvid>
  ...
  800096:	e8 99 ff ff ff       	call   800034 <umain>
	...
	// exit gracefully
	exit();
  80009b:	e8 0c 00 00 00       	call   8000ac <exit>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001b8:	e8 33 0b 00 00       	call   800cf0 <__udivdi3>
  ...
  8001f4:	e8 13 0c 00 00       	call   800e0c <__umoddi3>
  8001f9:	83 c4 14             	add    $0x14,%esp
  8001fc:	0f be 80 58 0f 80 00 	movsbl 0x800f58(%eax),%eax
  800203:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800340:	ff 24 85 20 10 80 00 	jmp    *0x801020(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003e7:	83 f8 08             	cmp    $0x8,%eax
  8003ea:	7f 0b                	jg     8003f7 <vprintfmt+0x142>
  8003ec:	8b 04 85 80 11 80 00 	mov    0x801180(,%eax,4),%eax
  8003f3:	85 c0                	test   %eax,%eax
  8003f5:	75 1a                	jne    800411 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003f7:	52                   	push   %edx
  8003f8:	68 70 0f 80 00       	push   $0x800f70
  8003fd:	57                   	push   %edi
  ...
  800411:	50                   	push   %eax
  800412:	68 79 0f 80 00       	push   $0x800f79
  800417:	57                   	push   %edi
  ...
  800446:	75 07                	jne    80044f <vprintfmt+0x19a>
				p = "(null)";
  800448:	c7 45 d0 69 0f 80 00 	movl   $0x800f69,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ab6:	68 a4 11 80 00       	push   $0x8011a4
  800abb:	6a 42                	push   $0x42
  800abd:	68 c1 11 80 00       	push   $0x8011c1
  800ac2:	e8 e1 01 00 00       	call   800ca8 <_panic>
...
sys_yield(void)
{
  ...
  800b7e:	e8 01 ff ff ff       	call   800a84 <syscall>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ba5:	e8 da fe ff ff       	call   800a84 <syscall>
}
  800baa:	c9                   	leave  
  800bab:	c3                   	ret    

00800bac <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bcb:	e8 b4 fe ff ff       	call   800a84 <syscall>
}
  800bd0:	c9                   	leave  
  800bd1:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bee:	e8 91 fe ff ff       	call   800a84 <syscall>
}
  800bf3:	c9                   	leave  
  800bf4:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c11:	e8 6e fe ff ff       	call   800a84 <syscall>
}
  800c16:	c9                   	leave  
  800c17:	c3                   	ret    

00800c18 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c34:	e8 4b fe ff ff       	call   800a84 <syscall>
}
  800c39:	c9                   	leave  
  800c3a:	c3                   	ret    
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800c43:	ff 75 14             	pushl  0x14(%ebp)
  ...
  800c59:	e8 26 fe ff ff       	call   800a84 <syscall>
}
  800c5e:	c9                   	leave  
  800c5f:	c3                   	ret    

00800c60 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  800c7b:	e8 04 fe ff ff       	call   800a84 <syscall>
}
  800c80:	c9                   	leave  
  800c81:	c3                   	ret    

00800c82 <sys_set_priority>:
...
sys_set_priority(envid_t envid, uint32_t new_priority)
{
  ...
  800c9e:	e8 e1 fd ff ff       	call   800a84 <syscall>
}
  800ca3:	c9                   	leave  
  800ca4:	c3                   	ret    
  800ca5:	00 00                	add    %al,(%eax)
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cac:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800cad:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800cb0:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800cb6:	e8 82 fe ff ff       	call   800b3d <sys_getenvid>
  800cbb:	83 ec 0c             	sub    $0xc,%esp
  800cbe:	ff 75 0c             	pushl  0xc(%ebp)
  800cc1:	ff 75 08             	pushl  0x8(%ebp)
  800cc4:	53                   	push   %ebx
  800cc5:	50                   	push   %eax
  800cc6:	68 d0 11 80 00       	push   $0x8011d0
  800ccb:	e8 80 f4 ff ff       	call   800150 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800cd0:	83 c4 18             	add    $0x18,%esp
  800cd3:	56                   	push   %esi
  800cd4:	ff 75 10             	pushl  0x10(%ebp)
  800cd7:	e8 23 f4 ff ff       	call   8000ff <vcprintf>
	cprintf("\n");
  800cdc:	c7 04 24 4c 0f 80 00 	movl   $0x800f4c,(%esp)
  800ce3:	e8 68 f4 ff ff       	call   800150 <cprintf>
  800ce8:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800ceb:	cc                   	int3   
  800cec:	eb fd                	jmp    800ceb <_panic+0x43>
	...
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800cfe:	89 7d f0             	mov    %edi,-0x10(%ebp)
  ...
  800d0c:	75 2e                	jne    800d3c <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800d0e:	39 f1                	cmp    %esi,%ecx
  800d10:	77 5a                	ja     800d6c <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800d14:	75 0b                	jne    800d21 <__udivdi3+0x31>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800d3a:	66 90                	xchg   %ax,%ax
    ...
    {
      if (d1 > n1)
  800d3c:	39 f0                	cmp    %esi,%eax
  800d3e:	77 1c                	ja     800d5c <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800d46:	75 3c                	jne    800d84 <__udivdi3+0x94>
  ...
  800d4a:	0f 82 90 00 00 00    	jb     800de0 <__udivdi3+0xf0>
  800d50:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800d53:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  800d56:	0f 86 84 00 00 00    	jbe    800de0 <__udivdi3+0xf0>
  800d5c:	31 f6                	xor    %esi,%esi
  800d5e:	31 ff                	xor    %edi,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800d88:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800d8b:	b8 20 00 00 00       	mov    $0x20,%eax
  800d90:	29 f8                	sub    %edi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800d92:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800d95:	88 c1                	mov    %al,%cl
  800d97:	d3 ea                	shr    %cl,%edx
  800d99:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800d9c:	09 ca                	or     %ecx,%edx
  800d9e:	89 55 ec             	mov    %edx,-0x14(%ebp)
	      d0 = d0 << bm;
  800da1:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800da4:	89 f9                	mov    %edi,%ecx
  800da6:	d3 e2                	shl    %cl,%edx
  800da8:	89 55 f4             	mov    %edx,-0xc(%ebp)
	      n2 = n1 >> b;
  800dab:	89 f2                	mov    %esi,%edx
  800dad:	88 c1                	mov    %al,%cl
  800daf:	d3 ea                	shr    %cl,%edx
  800db1:	89 55 e8             	mov    %edx,-0x18(%ebp)
	      n1 = (n1 << bm) | (n0 >> b);
  800db4:	89 f2                	mov    %esi,%edx
  800db6:	89 f9                	mov    %edi,%ecx
  800db8:	d3 e2                	shl    %cl,%edx
  800dba:	8b 75 f0             	mov    -0x10(%ebp),%esi
  800dbd:	88 c1                	mov    %al,%cl
  800dbf:	d3 ee                	shr    %cl,%esi
  800dc1:	09 d6                	or     %edx,%esi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800dc3:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800dc6:	89 f0                	mov    %esi,%eax
  800dc8:	89 ca                	mov    %ecx,%edx
  800dca:	f7 75 ec             	divl   -0x14(%ebp)
  800dcd:	89 d1                	mov    %edx,%ecx
  800dcf:	89 c6                	mov    %eax,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800dd1:	f7 65 f4             	mull   -0xc(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800dd4:	39 d1                	cmp    %edx,%ecx
  800dd6:	72 28                	jb     800e00 <__udivdi3+0x110>
  800dd8:	74 1a                	je     800df4 <__udivdi3+0x104>
  800dda:	89 f7                	mov    %esi,%edi
  800ddc:	31 f6                	xor    %esi,%esi
  800dde:	eb 80                	jmp    800d60 <__udivdi3+0x70>
	      /* The condition on the next line takes advantage of that
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
		{
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800df2:	66 90                	xchg   %ax,%ax
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800df4:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800df7:	89 f9                	mov    %edi,%ecx
  800df9:	d3 e2                	shl    %cl,%edx
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800dfb:	39 c2                	cmp    %eax,%edx
  800dfd:	73 db                	jae    800dda <__udivdi3+0xea>
  800dff:	90                   	nop
		{
		  q0--;
  800e00:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800e03:	31 f6                	xor    %esi,%esi
  800e05:	e9 56 ff ff ff       	jmp    800d60 <__udivdi3+0x70>
	...
...
{
  const DWunion nn = {.ll = n};
  800e1a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  800e1d:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800e20:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800e2d:	75 15                	jne    800e44 <__umoddi3+0x38>
    {
      if (d0 > n1)
  800e2f:	39 f1                	cmp    %esi,%ecx
  800e31:	0f 86 99 00 00 00    	jbe    800ed0 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */
  ...
  800e46:	0f 87 a4 00 00 00    	ja     800ef0 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800e4c:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  800e4f:	83 f0 1f             	xor    $0x1f,%eax
  800e52:	89 45 ec             	mov    %eax,-0x14(%ebp)
  800e55:	0f 84 a1 00 00 00    	je     800efc <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800e67:	2b 7d ec             	sub    -0x14(%ebp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  800e6a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800e6d:	89 f9                	mov    %edi,%ecx
  800e6f:	d3 ea                	shr    %cl,%edx
  800e71:	09 c2                	or     %eax,%edx
  800e73:	89 55 f0             	mov    %edx,-0x10(%ebp)
	      d0 = d0 << bm;
  ...
  800e83:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800e85:	8b 45 e8             	mov    -0x18(%ebp),%eax
  800e88:	d3 e0                	shl    %cl,%eax
  800e8a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800e8d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  800e90:	89 f9                	mov    %edi,%ecx
  800e92:	d3 e8                	shr    %cl,%eax
  800e94:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800e96:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800e98:	89 f2                	mov    %esi,%edx
  800e9a:	f7 75 f0             	divl   -0x10(%ebp)
  800e9d:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800e9f:	f7 65 f4             	mull   -0xc(%ebp)
  800ea2:	89 55 e8             	mov    %edx,-0x18(%ebp)
  800ea5:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800ea7:	39 d6                	cmp    %edx,%esi
  800ea9:	72 71                	jb     800f1c <__umoddi3+0x110>
  800eab:	74 7f                	je     800f2c <__umoddi3+0x120>
	      q1 = 0;
  ...
  800ed2:	75 0b                	jne    800edf <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  800eea:	e9 4a ff ff ff       	jmp    800e39 <__umoddi3+0x2d>
  800eef:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  800efe:	72 05                	jb     800f05 <__umoddi3+0xf9>
  800f00:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  800f03:	77 0c                	ja     800f11 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f05:	89 f2                	mov    %esi,%edx
  800f07:	8b 45 f0             	mov    -0x10(%ebp),%eax
  800f0a:	29 c8                	sub    %ecx,%eax
  800f0c:	19 fa                	sbb    %edi,%edx
  ...
  800f1b:	90                   	nop
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
		{
		  q0--;
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800f1c:	8b 55 e8             	mov    -0x18(%ebp),%edx
  800f1f:	89 c1                	mov    %eax,%ecx
  800f21:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  800f24:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  800f27:	eb 84                	jmp    800ead <__umoddi3+0xa1>
  800f29:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800f2c:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  800f2f:	72 eb                	jb     800f1c <__umoddi3+0x110>
  800f31:	89 f2                	mov    %esi,%edx
  800f33:	e9 75 ff ff ff       	jmp    800ead <__umoddi3+0xa1>
