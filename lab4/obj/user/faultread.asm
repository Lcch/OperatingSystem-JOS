	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f0:	0f be 80 48 0f 80 00 	movsbl 0x800f48(%eax),%eax
  8001f7:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800334:	ff 24 85 00 10 80 00 	jmp    *0x801000(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003e0:	8b 04 85 60 11 80 00 	mov    0x801160(,%eax,4),%eax
  8003e7:	85 c0                	test   %eax,%eax
  8003e9:	75 1a                	jne    800405 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003eb:	52                   	push   %edx
  8003ec:	68 60 0f 80 00       	push   $0x800f60
  8003f1:	57                   	push   %edi
  ...
  800405:	50                   	push   %eax
  800406:	68 69 0f 80 00       	push   $0x800f69
  80040b:	57                   	push   %edi
  ...
  80043a:	75 07                	jne    800443 <vprintfmt+0x19a>
				p = "(null)";
  80043c:	c7 45 d0 59 0f 80 00 	movl   $0x800f59,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aaa:	68 84 11 80 00       	push   $0x801184
  800aaf:	6a 42                	push   $0x42
  800ab1:	68 a1 11 80 00       	push   $0x8011a1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c94:	53                   	push   %ebx
  800c95:	50                   	push   %eax
  800c96:	68 b0 11 80 00       	push   $0x8011b0
  ...
  800ca7:	e8 47 f4 ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  800cac:	c7 04 24 3c 0f 80 00 	movl   $0x800f3c,(%esp)
