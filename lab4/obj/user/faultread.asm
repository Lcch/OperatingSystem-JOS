	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e8:	0f be 80 68 0f 80 00 	movsbl 0x800f68(%eax),%eax
  8001ef:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032c:	ff 24 85 20 10 80 00 	jmp    *0x801020(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003d8:	8b 04 85 80 11 80 00 	mov    0x801180(,%eax,4),%eax
  8003df:	85 c0                	test   %eax,%eax
  8003e1:	75 1a                	jne    8003fd <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003e3:	52                   	push   %edx
  8003e4:	68 80 0f 80 00       	push   $0x800f80
  8003e9:	57                   	push   %edi
  ...
  8003fd:	50                   	push   %eax
  8003fe:	68 89 0f 80 00       	push   $0x800f89
  800403:	57                   	push   %edi
  ...
  800432:	75 07                	jne    80043b <vprintfmt+0x19a>
				p = "(null)";
  800434:	c7 45 d0 79 0f 80 00 	movl   $0x800f79,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aa2:	68 a4 11 80 00       	push   $0x8011a4
  800aa7:	6a 42                	push   $0x42
  800aa9:	68 c1 11 80 00       	push   $0x8011c1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cb0:	53                   	push   %ebx
  800cb1:	50                   	push   %eax
  800cb2:	68 d0 11 80 00       	push   $0x8011d0
  ...
  800cc3:	e8 23 f4 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800cc8:	c7 04 24 5c 0f 80 00 	movl   $0x800f5c,(%esp)
