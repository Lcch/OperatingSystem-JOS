	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ec:	0f be 80 cc 0d 80 00 	movsbl 0x800dcc(%eax),%eax
  8001f3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800330:	ff 24 85 5c 0e 80 00 	jmp    *0x800e5c(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003dc:	8b 04 85 b4 0f 80 00 	mov    0x800fb4(,%eax,4),%eax
  8003e3:	85 c0                	test   %eax,%eax
  8003e5:	75 1a                	jne    800401 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003e7:	52                   	push   %edx
  8003e8:	68 e4 0d 80 00       	push   $0x800de4
  8003ed:	57                   	push   %edi
  ...
  800401:	50                   	push   %eax
  800402:	68 ed 0d 80 00       	push   $0x800ded
  800407:	57                   	push   %edi
  ...
  800436:	75 07                	jne    80043f <vprintfmt+0x19a>
				p = "(null)";
  800438:	c7 45 d0 dd 0d 80 00 	movl   $0x800ddd,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad9:	68 d0 0f 80 00       	push   $0x800fd0
  800ade:	6a 23                	push   $0x23
  800ae0:	68 ed 0f 80 00       	push   $0x800fed
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b30:	53                   	push   %ebx
  800b31:	50                   	push   %eax
  800b32:	68 fc 0f 80 00       	push   $0x800ffc
  ...
  800b43:	e8 a7 f5 ff ff       	call   8000ef <vcprintf>
	cprintf("\n");
  800b48:	c7 04 24 c0 0d 80 00 	movl   $0x800dc0,(%esp)
