	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d8:	0f be 80 b8 0d 80 00 	movsbl 0x800db8(%eax),%eax
  8001df:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80031c:	ff 24 85 48 0e 80 00 	jmp    *0x800e48(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003c8:	8b 04 85 a0 0f 80 00 	mov    0x800fa0(,%eax,4),%eax
  8003cf:	85 c0                	test   %eax,%eax
  8003d1:	75 1a                	jne    8003ed <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003d3:	52                   	push   %edx
  8003d4:	68 d0 0d 80 00       	push   $0x800dd0
  8003d9:	57                   	push   %edi
  ...
  8003ed:	50                   	push   %eax
  8003ee:	68 d9 0d 80 00       	push   $0x800dd9
  8003f3:	57                   	push   %edi
  ...
  800422:	75 07                	jne    80042b <vprintfmt+0x19a>
				p = "(null)";
  800424:	c7 45 d0 c9 0d 80 00 	movl   $0x800dc9,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ac5:	68 bc 0f 80 00       	push   $0x800fbc
  800aca:	6a 23                	push   $0x23
  800acc:	68 d9 0f 80 00       	push   $0x800fd9
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b1c:	53                   	push   %ebx
  800b1d:	50                   	push   %eax
  800b1e:	68 e8 0f 80 00       	push   $0x800fe8
  ...
  800b2f:	e8 a7 f5 ff ff       	call   8000db <vcprintf>
	cprintf("\n");
  800b34:	c7 04 24 ac 0d 80 00 	movl   $0x800dac,(%esp)
