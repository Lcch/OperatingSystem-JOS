	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ec:	0f be 80 15 0e 80 00 	movsbl 0x800e15(%eax),%eax
  8001f3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800330:	ff 24 85 a4 0e 80 00 	jmp    *0x800ea4(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8003dc:	8b 04 85 fc 0f 80 00 	mov    0x800ffc(,%eax,4),%eax
  8003e3:	85 c0                	test   %eax,%eax
  8003e5:	75 1a                	jne    800401 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8003e7:	52                   	push   %edx
  8003e8:	68 2d 0e 80 00       	push   $0x800e2d
  8003ed:	57                   	push   %edi
  ...
  800401:	50                   	push   %eax
  800402:	68 36 0e 80 00       	push   $0x800e36
  800407:	57                   	push   %edi
  ...
  800436:	75 07                	jne    80043f <vprintfmt+0x19a>
				p = "(null)";
  800438:	c7 45 d0 26 0e 80 00 	movl   $0x800e26,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aa6:	68 18 10 80 00       	push   $0x801018
  800aab:	6a 42                	push   $0x42
  800aad:	68 35 10 80 00       	push   $0x801035
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b70:	53                   	push   %ebx
  800b71:	50                   	push   %eax
  800b72:	68 44 10 80 00       	push   $0x801044
  ...
  800b83:	e8 67 f5 ff ff       	call   8000ef <vcprintf>
	cprintf("\n");
  800b88:	c7 04 24 68 10 80 00 	movl   $0x801068,(%esp)
