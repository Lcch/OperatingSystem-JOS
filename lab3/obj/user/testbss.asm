...
umain(int argc, char **argv)
{
  ...
  80003a:	68 38 0e 80 00       	push   $0x800e38
  80003f:	e8 d8 01 00 00       	call   80021c <cprintf>
...
umain(int argc, char **argv)
{
  ...
  800066:	50                   	push   %eax
  800067:	68 b3 0e 80 00       	push   $0x800eb3
  80006c:	6a 11                	push   $0x11
  80006e:	68 d0 0e 80 00       	push   $0x800ed0
  800073:	e8 cc 00 00 00       	call   800144 <_panic>
umain(int argc, char **argv)
{
	int i;
  ...
  8000b2:	50                   	push   %eax
  8000b3:	68 58 0e 80 00       	push   $0x800e58
  8000b8:	6a 16                	push   $0x16
  8000ba:	68 d0 0e 80 00       	push   $0x800ed0
  8000bf:	e8 80 00 00 00       	call   800144 <_panic>
	for (i = 0; i < ARRAYSIZE; i++)
		if (bigarray[i] != 0)
			panic("bigarray[%d] isn't cleared!\n", i);
	for (i = 0; i < ARRAYSIZE; i++)
  ...
  8000cf:	68 80 0e 80 00       	push   $0x800e80
  8000d4:	e8 43 01 00 00       	call   80021c <cprintf>
	bigarray[ARRAYSIZE+1024] = 0;
  8000d9:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8000e0:	00 00 00 
	panic("SHOULD HAVE TRAPPED!!!");
  8000e3:	83 c4 0c             	add    $0xc,%esp
  8000e6:	68 df 0e 80 00       	push   $0x800edf
  8000eb:	6a 1a                	push   $0x1a
  8000ed:	68 d0 0e 80 00       	push   $0x800ed0
  8000f2:	e8 4d 00 00 00       	call   800144 <_panic>
	...
...
libmain(int argc, char **argv)
{
  ...
  800101:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = 0;
  800104:	c7 05 20 20 c0 00 00 	movl   $0x0,0xc02020
  80010b:	00 00 00 
  ...
  80011f:	e8 10 ff ff ff       	call   800034 <umain>
	...
	// exit gracefully
	exit();
  800124:	e8 07 00 00 00       	call   800130 <exit>
...
exit(void)
{
  ...
  800138:	e8 50 0a 00 00       	call   800b8d <sys_env_destroy>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80014c:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800152:	e8 77 0a 00 00       	call   800bce <sys_getenvid>
  800157:	83 ec 0c             	sub    $0xc,%esp
  80015a:	ff 75 0c             	pushl  0xc(%ebp)
  80015d:	ff 75 08             	pushl  0x8(%ebp)
  800160:	53                   	push   %ebx
  800161:	50                   	push   %eax
  800162:	68 00 0f 80 00       	push   $0x800f00
  ...
  800173:	e8 53 00 00 00       	call   8001cb <vcprintf>
	cprintf("\n");
  800178:	c7 04 24 ce 0e 80 00 	movl   $0x800ece,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001b4:	50                   	push   %eax
  8001b5:	e8 96 09 00 00       	call   800b50 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80020e:	50                   	push   %eax
  80020f:	e8 3c 09 00 00       	call   800b50 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800284:	e8 67 09 00 00       	call   800bf0 <__udivdi3>
  ...
  8002c0:	e8 47 0a 00 00       	call   800d0c <__umoddi3>
  8002c5:	83 c4 14             	add    $0x14,%esp
  8002c8:	0f be 80 24 0f 80 00 	movsbl 0x800f24(%eax),%eax
  8002cf:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80040c:	ff 24 85 b4 0f 80 00 	jmp    *0x800fb4(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004b8:	8b 04 85 0c 11 80 00 	mov    0x80110c(,%eax,4),%eax
  8004bf:	85 c0                	test   %eax,%eax
  8004c1:	75 1a                	jne    8004dd <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8004c3:	52                   	push   %edx
  8004c4:	68 3c 0f 80 00       	push   $0x800f3c
  8004c9:	57                   	push   %edi
  ...
  8004dd:	50                   	push   %eax
  8004de:	68 45 0f 80 00       	push   $0x800f45
  8004e3:	57                   	push   %edi
  ...
  800512:	75 07                	jne    80051b <vprintfmt+0x19a>
				p = "(null)";
  800514:	c7 45 d0 35 0f 80 00 	movl   $0x800f35,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800bb5:	68 28 11 80 00       	push   $0x801128
  800bba:	6a 23                	push   $0x23
  800bbc:	68 45 11 80 00       	push   $0x801145
  800bc1:	e8 7e f5 ff ff       	call   800144 <_panic>
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800bfe:	89 7d f0             	mov    %edi,-0x10(%ebp)
  800c01:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800c04:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800c0c:	75 2e                	jne    800c3c <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800c0e:	39 f1                	cmp    %esi,%ecx
  800c10:	77 5a                	ja     800c6c <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800c14:	75 0b                	jne    800c21 <__udivdi3+0x31>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800c3e:	77 1c                	ja     800c5c <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800c46:	75 3c                	jne    800c84 <__udivdi3+0x94>
  ...
  800c4a:	0f 82 90 00 00 00    	jb     800ce0 <__udivdi3+0xf0>
  800c50:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800c53:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  800c56:	0f 86 84 00 00 00    	jbe    800ce0 <__udivdi3+0xf0>
  800c5c:	31 f6                	xor    %esi,%esi
  800c5e:	31 ff                	xor    %edi,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800c88:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800c8b:	b8 20 00 00 00       	mov    $0x20,%eax
  800c90:	29 f8                	sub    %edi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800c92:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800c95:	88 c1                	mov    %al,%cl
  800c97:	d3 ea                	shr    %cl,%edx
  800c99:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800c9c:	09 ca                	or     %ecx,%edx
  800c9e:	89 55 ec             	mov    %edx,-0x14(%ebp)
	      d0 = d0 << bm;
  800ca1:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800ca4:	89 f9                	mov    %edi,%ecx
  800ca6:	d3 e2                	shl    %cl,%edx
  800ca8:	89 55 f4             	mov    %edx,-0xc(%ebp)
	      n2 = n1 >> b;
  800cab:	89 f2                	mov    %esi,%edx
  800cad:	88 c1                	mov    %al,%cl
  800caf:	d3 ea                	shr    %cl,%edx
  800cb1:	89 55 e8             	mov    %edx,-0x18(%ebp)
	      n1 = (n1 << bm) | (n0 >> b);
  800cb4:	89 f2                	mov    %esi,%edx
  800cb6:	89 f9                	mov    %edi,%ecx
  800cb8:	d3 e2                	shl    %cl,%edx
  800cba:	8b 75 f0             	mov    -0x10(%ebp),%esi
  800cbd:	88 c1                	mov    %al,%cl
  800cbf:	d3 ee                	shr    %cl,%esi
  800cc1:	09 d6                	or     %edx,%esi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800cc3:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800cc6:	89 f0                	mov    %esi,%eax
  800cc8:	89 ca                	mov    %ecx,%edx
  800cca:	f7 75 ec             	divl   -0x14(%ebp)
  800ccd:	89 d1                	mov    %edx,%ecx
  800ccf:	89 c6                	mov    %eax,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800cd1:	f7 65 f4             	mull   -0xc(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800cd4:	39 d1                	cmp    %edx,%ecx
  800cd6:	72 28                	jb     800d00 <__udivdi3+0x110>
  800cd8:	74 1a                	je     800cf4 <__udivdi3+0x104>
  800cda:	89 f7                	mov    %esi,%edi
  800cdc:	31 f6                	xor    %esi,%esi
  800cde:	eb 80                	jmp    800c60 <__udivdi3+0x70>
	      /* The condition on the next line takes advantage of that
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
		{
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800cf2:	66 90                	xchg   %ax,%ax
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800cf4:	8b 55 f0             	mov    -0x10(%ebp),%edx
  ...
  800cfd:	73 db                	jae    800cda <__udivdi3+0xea>
  800cff:	90                   	nop
		{
		  q0--;
  800d00:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800d03:	31 f6                	xor    %esi,%esi
  800d05:	e9 56 ff ff ff       	jmp    800c60 <__udivdi3+0x70>
	...
...
{
  const DWunion nn = {.ll = n};
  800d1a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  ...
  800d2d:	75 15                	jne    800d44 <__umoddi3+0x38>
    {
      if (d0 > n1)
  800d2f:	39 f1                	cmp    %esi,%ecx
  800d31:	0f 86 99 00 00 00    	jbe    800dd0 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */
  ...
  800d46:	0f 87 a4 00 00 00    	ja     800df0 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800d4c:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  800d4f:	83 f0 1f             	xor    $0x1f,%eax
  800d52:	89 45 ec             	mov    %eax,-0x14(%ebp)
  800d55:	0f 84 a1 00 00 00    	je     800dfc <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800d67:	2b 7d ec             	sub    -0x14(%ebp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  800d6a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800d6d:	89 f9                	mov    %edi,%ecx
  800d6f:	d3 ea                	shr    %cl,%edx
  800d71:	09 c2                	or     %eax,%edx
  800d73:	89 55 f0             	mov    %edx,-0x10(%ebp)
	      d0 = d0 << bm;
  800d76:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800d79:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800d7c:	d3 e0                	shl    %cl,%eax
  800d7e:	89 45 f4             	mov    %eax,-0xc(%ebp)
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800d81:	89 f2                	mov    %esi,%edx
  800d83:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800d85:	8b 45 e8             	mov    -0x18(%ebp),%eax
  800d88:	d3 e0                	shl    %cl,%eax
  800d8a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800d8d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  800d90:	89 f9                	mov    %edi,%ecx
  800d92:	d3 e8                	shr    %cl,%eax
  ...
  800d9a:	f7 75 f0             	divl   -0x10(%ebp)
  800d9d:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800d9f:	f7 65 f4             	mull   -0xc(%ebp)
  800da2:	89 55 e8             	mov    %edx,-0x18(%ebp)
  800da5:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800da7:	39 d6                	cmp    %edx,%esi
  800da9:	72 71                	jb     800e1c <__umoddi3+0x110>
  800dab:	74 7f                	je     800e2c <__umoddi3+0x120>
	      q1 = 0;
  ...
  800db0:	29 c8                	sub    %ecx,%eax
  800db2:	19 d6                	sbb    %edx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  800db4:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  800dc3:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  800dd2:	75 0b                	jne    800ddf <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  800dea:	e9 4a ff ff ff       	jmp    800d39 <__umoddi3+0x2d>
  800def:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  800df9:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800dfc:	39 f7                	cmp    %esi,%edi
  800dfe:	72 05                	jb     800e05 <__umoddi3+0xf9>
  800e00:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  800e03:	77 0c                	ja     800e11 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800e05:	89 f2                	mov    %esi,%edx
  800e07:	8b 45 f0             	mov    -0x10(%ebp),%eax
  800e0a:	29 c8                	sub    %ecx,%eax
  800e0c:	19 fa                	sbb    %edi,%edx
  ...
  800e21:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  800e24:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  800e27:	eb 84                	jmp    800dad <__umoddi3+0xa1>
  800e29:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800e2c:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  800e2f:	72 eb                	jb     800e1c <__umoddi3+0x110>
  800e31:	89 f2                	mov    %esi,%edx
  800e33:	e9 75 ff ff ff       	jmp    800dad <__umoddi3+0xa1>
