...
libmain(int argc, char **argv)
{
  ...
  800061:	52                   	push   %edx
  800062:	50                   	push   %eax
  800063:	e8 cc ff ff ff       	call   800034 <umain>

	// exit gracefully
	exit();
  800068:	e8 07 00 00 00       	call   800074 <exit>
...
exit(void)
{
  ...
  80007c:	e8 44 00 00 00       	call   8000c5 <sys_env_destroy>
...
sys_env_destroy(envid_t envid)
{
  ...
  8000e5:	7e 17                	jle    8000fe <sys_env_destroy+0x39>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000e7:	83 ec 0c             	sub    $0xc,%esp
  8000ea:	50                   	push   %eax
  8000eb:	6a 03                	push   $0x3
  8000ed:	68 86 0d 80 00       	push   $0x800d86
  8000f2:	6a 23                	push   $0x23
  8000f4:	68 a3 0d 80 00       	push   $0x800da3
  8000f9:	e8 2a 00 00 00       	call   800128 <_panic>
...
sys_getenvid(void)
{
  ...
  800111:	b8 02 00 00 00       	mov    $0x2,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800130:	8b 1d 00 10 80 00    	mov    0x801000,%ebx
  800136:	e8 cb ff ff ff       	call   800106 <sys_getenvid>
  80013b:	83 ec 0c             	sub    $0xc,%esp
  80013e:	ff 75 0c             	pushl  0xc(%ebp)
  800141:	ff 75 08             	pushl  0x8(%ebp)
  800144:	53                   	push   %ebx
  800145:	50                   	push   %eax
  800146:	68 b4 0d 80 00       	push   $0x800db4
  ...
  800157:	e8 53 00 00 00       	call   8001af <vcprintf>
	cprintf("\n");
  80015c:	c7 04 24 d8 0d 80 00 	movl   $0x800dd8,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800198:	50                   	push   %eax
  800199:	e8 ea fe ff ff       	call   800088 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001f2:	50                   	push   %eax
  8001f3:	e8 90 fe ff ff       	call   800088 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	e8 c7 08 00 00       	call   800b34 <__udivdi3>
  ...
  8002a4:	e8 a7 09 00 00       	call   800c50 <__umoddi3>
  8002a9:	83 c4 14             	add    $0x14,%esp
  8002ac:	0f be 80 da 0d 80 00 	movsbl 0x800dda(%eax),%eax
  8002b3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f0:	ff 24 85 68 0e 80 00 	jmp    *0x800e68(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80049c:	8b 04 85 c0 0f 80 00 	mov    0x800fc0(,%eax,4),%eax
  8004a3:	85 c0                	test   %eax,%eax
  8004a5:	75 1a                	jne    8004c1 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8004a7:	52                   	push   %edx
  8004a8:	68 f2 0d 80 00       	push   $0x800df2
  8004ad:	57                   	push   %edi
  ...
  8004c1:	50                   	push   %eax
  8004c2:	68 fb 0d 80 00       	push   $0x800dfb
  8004c7:	57                   	push   %edi
  ...
  8004f6:	75 07                	jne    8004ff <vprintfmt+0x19a>
				p = "(null)";
  8004f8:	c7 45 d0 eb 0d 80 00 	movl   $0x800deb,-0x30(%ebp)
			if (width > 0 && padc != '-')
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800b42:	89 7d f0             	mov    %edi,-0x10(%ebp)
  800b45:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800b48:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800b50:	75 2e                	jne    800b80 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800b52:	39 f1                	cmp    %esi,%ecx
  800b54:	77 5a                	ja     800bb0 <__udivdi3+0x7c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800b58:	75 0b                	jne    800b65 <__udivdi3+0x31>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800b82:	77 1c                	ja     800ba0 <__udivdi3+0x6c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800b84:	0f bd f8             	bsr    %eax,%edi
	  if (bm == 0)
  800b87:	83 f7 1f             	xor    $0x1f,%edi
  800b8a:	75 3c                	jne    800bc8 <__udivdi3+0x94>
  ...
  800b8e:	0f 82 90 00 00 00    	jb     800c24 <__udivdi3+0xf0>
  800b94:	8b 55 f0             	mov    -0x10(%ebp),%edx
  800b97:	39 55 f4             	cmp    %edx,-0xc(%ebp)
  800b9a:	0f 86 84 00 00 00    	jbe    800c24 <__udivdi3+0xf0>
  800ba0:	31 f6                	xor    %esi,%esi
  800ba2:	31 ff                	xor    %edi,%edi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800bc5:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800bc8:	89 f9                	mov    %edi,%ecx
  800bca:	d3 e0                	shl    %cl,%eax
  800bcc:	89 45 e8             	mov    %eax,-0x18(%ebp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800bcf:	b8 20 00 00 00       	mov    $0x20,%eax
  ...
  800bdd:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800be0:	09 ca                	or     %ecx,%edx
  800be2:	89 55 ec             	mov    %edx,-0x14(%ebp)
	      d0 = d0 << bm;
  800be5:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800be8:	89 f9                	mov    %edi,%ecx
  800bea:	d3 e2                	shl    %cl,%edx
  800bec:	89 55 f4             	mov    %edx,-0xc(%ebp)
	      n2 = n1 >> b;
  800bef:	89 f2                	mov    %esi,%edx
  800bf1:	88 c1                	mov    %al,%cl
  800bf3:	d3 ea                	shr    %cl,%edx
  800bf5:	89 55 e8             	mov    %edx,-0x18(%ebp)
	      n1 = (n1 << bm) | (n0 >> b);
  800bf8:	89 f2                	mov    %esi,%edx
  800bfa:	89 f9                	mov    %edi,%ecx
  800bfc:	d3 e2                	shl    %cl,%edx
  800bfe:	8b 75 f0             	mov    -0x10(%ebp),%esi
  800c01:	88 c1                	mov    %al,%cl
  800c03:	d3 ee                	shr    %cl,%esi
  800c05:	09 d6                	or     %edx,%esi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800c07:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  800c0a:	89 f0                	mov    %esi,%eax
  800c0c:	89 ca                	mov    %ecx,%edx
  800c0e:	f7 75 ec             	divl   -0x14(%ebp)
  800c11:	89 d1                	mov    %edx,%ecx
  800c13:	89 c6                	mov    %eax,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800c15:	f7 65 f4             	mull   -0xc(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800c18:	39 d1                	cmp    %edx,%ecx
  800c1a:	72 28                	jb     800c44 <__udivdi3+0x110>
  800c1c:	74 1a                	je     800c38 <__udivdi3+0x104>
  800c1e:	89 f7                	mov    %esi,%edi
  800c20:	31 f6                	xor    %esi,%esi
  800c22:	eb 80                	jmp    800ba4 <__udivdi3+0x70>
	      /* The condition on the next line takes advantage of that
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
		{
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800c3b:	89 f9                	mov    %edi,%ecx
  800c3d:	d3 e2                	shl    %cl,%edx
  ...
  800c41:	73 db                	jae    800c1e <__udivdi3+0xea>
  800c43:	90                   	nop
		{
		  q0--;
  800c44:	8d 7e ff             	lea    -0x1(%esi),%edi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800c47:	31 f6                	xor    %esi,%esi
  800c49:	e9 56 ff ff ff       	jmp    800ba4 <__udivdi3+0x70>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800c5b:	8b 4d 10             	mov    0x10(%ebp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800c5e:	89 45 e8             	mov    %eax,-0x18(%ebp)
  800c61:	8b 75 0c             	mov    0xc(%ebp),%esi
  const DWunion dd = {.ll = d};
  800c64:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  ...
  800c71:	75 15                	jne    800c88 <__umoddi3+0x38>
    {
      if (d0 > n1)
  800c73:	39 f1                	cmp    %esi,%ecx
  800c75:	0f 86 99 00 00 00    	jbe    800d14 <__umoddi3+0xc4>
	{
	  /* 0q = nn / 0D */

	  udiv_qrnnd (q0, n0, n1, n0, d0);
  800c7b:	f7 f1                	div    %ecx
  ...
  800c87:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800c88:	39 f7                	cmp    %esi,%edi
  800c8a:	0f 87 a4 00 00 00    	ja     800d34 <__umoddi3+0xe4>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800c90:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  800c93:	83 f0 1f             	xor    $0x1f,%eax
  800c96:	89 45 ec             	mov    %eax,-0x14(%ebp)
  800c99:	0f 84 a1 00 00 00    	je     800d40 <__umoddi3+0xf0>
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800ca1:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800ca4:	d3 e0                	shl    %cl,%eax
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800cab:	2b 7d ec             	sub    -0x14(%ebp),%edi
  ...
  800cc7:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800cc9:	8b 45 e8             	mov    -0x18(%ebp),%eax
  ...
  800cd4:	89 f9                	mov    %edi,%ecx
  800cd6:	d3 e8                	shr    %cl,%eax
  800cd8:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800cda:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800cdc:	89 f2                	mov    %esi,%edx
  800cde:	f7 75 f0             	divl   -0x10(%ebp)
  800ce1:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800ce3:	f7 65 f4             	mull   -0xc(%ebp)
  800ce6:	89 55 e8             	mov    %edx,-0x18(%ebp)
  800ce9:	89 c1                	mov    %eax,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800ceb:	39 d6                	cmp    %edx,%esi
  800ced:	72 71                	jb     800d60 <__umoddi3+0x110>
  800cef:	74 7f                	je     800d70 <__umoddi3+0x120>
	      q1 = 0;
  ...
  800cf4:	29 c8                	sub    %ecx,%eax
  800cf6:	19 d6                	sbb    %edx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  800cf8:	8a 4d ec             	mov    -0x14(%ebp),%cl
  ...
  800d07:	8a 4d ec             	mov    -0x14(%ebp),%cl
  800d0a:	d3 ea                	shr    %cl,%edx
  UDWtype w;
  ...
  800d16:	75 0b                	jne    800d23 <__umoddi3+0xd3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  800d2e:	e9 4a ff ff ff       	jmp    800c7d <__umoddi3+0x2d>
  800d33:	90                   	nop
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
  ...
  800d3d:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800d40:	39 f7                	cmp    %esi,%edi
  800d42:	72 05                	jb     800d49 <__umoddi3+0xf9>
  800d44:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  800d47:	77 0c                	ja     800d55 <__umoddi3+0x105>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800d49:	89 f2                	mov    %esi,%edx
  800d4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  800d4e:	29 c8                	sub    %ecx,%eax
  800d50:	19 fa                	sbb    %edi,%edx
  ...
  800d5f:	90                   	nop
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
		{
		  q0--;
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800d60:	8b 55 e8             	mov    -0x18(%ebp),%edx
  800d63:	89 c1                	mov    %eax,%ecx
  800d65:	2b 4d f4             	sub    -0xc(%ebp),%ecx
  800d68:	1b 55 f0             	sbb    -0x10(%ebp),%edx
  800d6b:	eb 84                	jmp    800cf1 <__umoddi3+0xa1>
  800d6d:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800d70:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  800d73:	72 eb                	jb     800d60 <__umoddi3+0x110>
  800d75:	89 f2                	mov    %esi,%edx
  800d77:	e9 75 ff ff ff       	jmp    800cf1 <__umoddi3+0xa1>
