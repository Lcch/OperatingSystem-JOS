...
sys_env_destroy(envid_t envid)
{
  ...
  800101:	68 9a 0d 80 00       	push   $0x800d9a
  800106:	6a 23                	push   $0x23
  800108:	68 b7 0d 80 00       	push   $0x800db7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800144:	8b 1d 00 10 80 00    	mov    0x801000,%ebx
  ...
  800158:	53                   	push   %ebx
  800159:	50                   	push   %eax
  80015a:	68 c8 0d 80 00       	push   $0x800dc8
  ...
  80016b:	e8 53 00 00 00       	call   8001c3 <vcprintf>
	cprintf("\n");
  800170:	c7 04 24 ec 0d 80 00 	movl   $0x800dec,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002c0:	0f be 80 ee 0d 80 00 	movsbl 0x800dee(%eax),%eax
  8002c7:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800404:	ff 24 85 7c 0e 80 00 	jmp    *0x800e7c(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004b0:	8b 04 85 d4 0f 80 00 	mov    0x800fd4(,%eax,4),%eax
  8004b7:	85 c0                	test   %eax,%eax
  8004b9:	75 1a                	jne    8004d5 <vprintfmt+0x15c>
				printfmt(putch, putdat, "error %d", err);
  8004bb:	52                   	push   %edx
  8004bc:	68 06 0e 80 00       	push   $0x800e06
  8004c1:	57                   	push   %edi
  ...
  8004d5:	50                   	push   %eax
  8004d6:	68 0f 0e 80 00       	push   $0x800e0f
  8004db:	57                   	push   %edi
  ...
  80050a:	75 07                	jne    800513 <vprintfmt+0x19a>
				p = "(null)";
  80050c:	c7 45 d0 ff 0d 80 00 	movl   $0x800dff,-0x30(%ebp)
			if (width > 0 && padc != '-')
